...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>4.0.0-rc.0 - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#400-rc0" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/stylehacks/CHANGELOG.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<li>Breaking: Removes the browsers option, as it has been superseded by using
  ...
  for more details.</li>
<li>Breaking: Removes the <code>silent</code> option &amp; logger; now stylehacks will add the
  warnings to <code>Result#messages</code>. If you would like logging this can be handled
  in your PostCSS runner.</li>
<li>Breaking: Removes the CLI from stylehacks. We recommend using a PostCSS
  runner instead as it's easier to add stylehacks into an existing setup rather
  than using a separate command.</li>
</ul>
<h1 id="232">2.3.2</h1>
<ul>
<li>Resolves an issue where stylehacks would crash on CSS mixins.</li>
</ul>
<h1 id="231">2.3.1</h1>
<ul>
<li>Upgraded postcss-selector-parser to <code>v2.0.0</code>.</li>
<li>Fixed an issue where stylehacks was not removing <code>*zoom: 1</code> from rules
  generated by other PostCSS plugins.</li>
</ul>
<h1 id="230">2.3.0</h1>
<ul>
<li>Each warning now contains more information about the hack; what identifier
  it targets, what the hack is, and the browsers that it affects. E.g:</li>
</ul>
<p><code>js
  {
...
<h1 id="220">2.2.0</h1>
<ul>
<li>Added <code>value\9</code> hack.</li>
</ul>
<h1 id="210">2.1.0</h1>
<ul>
<li>Added <code>html ~ /**/ body .selector</code> hack.</li>
<li>Added a method to detect if a PostCSS node has any hacks.</li>
</ul>
<h1 id="200">2.0.0</h1>
<ul>
<li>Added <code>body:empty</code> &amp; <code>html:first-child</code> hacks.</li>
