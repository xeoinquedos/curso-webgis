      ...
      7. Extra 1. Un visor rápido con datos vectoriales de OSM usando uMap
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/caniuse-db/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                  <h1>Home</h1>
                
                <p><img alt="" src="https://travis-ci.org/Fyrd/caniuse.svg?branch=master" /></p>
<p>This repo contains raw data from the caniuse.com support tables. It serves two purposes:</p>
<ol>
<li>
<p>The ability for anyone interested to update or add to the support data on the site. If you are interested in this, please read the <a href="CONTRIBUTING/">CONTRIBUTING file</a>.</p>
</li>
<li>
<p>Access to the site's data for other projects. For this use the <a href="data.json"><code>data.json</code></a> file which includes all support data.</p>
</li>
</ol>
