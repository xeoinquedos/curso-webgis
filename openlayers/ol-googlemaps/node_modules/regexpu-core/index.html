...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#regexpu-core" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#rewritepatternpattern-flags" title="rewritePattern(pattern, flags)" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/regexpu-core/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="regexpu-core">regexpu-core <a href="https://travis-ci.org/mathiasbynens/regexpu-core"><img alt="Build status" src="https://travis-ci.org/mathiasbynens/regexpu-core.svg?branch=master" /></a> <a href="https://coveralls.io/r/mathiasbynens/regexpu-core"><img alt="Code coverage status" src="http://img.shields.io/coveralls/mathiasbynens/regexpu-core/master.svg" /></a> <a href="https://gemnasium.com/mathiasbynens/regexpu-core"><img alt="Dependency status" src="https://gemnasium.com/mathiasbynens/regexpu-core.svg" /></a></h1>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install regexpu-core --save-dev
</pre></div>
</td></tr></table>

<p>Then, <code>require</code> it:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">const</span> <span class="nx">rewritePattern</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;regexpu-core&#39;</span><span class="p">);</span>
</pre></div>
</td></tr></table>

<h2 id="api">API</h2>
<p>This module exports a single function named <code>rewritePattern</code>.</p>
<h3 id="rewritepatternpattern-flags"><code>rewritePattern(pattern, flags)</code></h3>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">rewritePattern</span><span class="p">(</span><span class="s1">&#39;foo.bar&#39;</span><span class="p">,</span> <span class="s1">&#39;u&#39;</span><span class="p">);</span>
<span class="c1">// → &#39;foo(?:[\\0-\\t\\x0B\\f\\x0E-\\u2027\\u202A-\\uD7FF\\uDC00-\\uFFFF]|[\\uD800-\\uDBFF][\\uDC00-\\uDFFF]|[\\uD800-\\uDBFF])bar&#39;</span>

<span class="nx">rewritePattern</span><span class="p">(</span><span class="s1">&#39;[\\u{1D306}-\\u{1D308}a-z]&#39;</span><span class="p">,</span> <span class="s1">&#39;u&#39;</span><span class="p">);</span>
<span class="c1">// → &#39;(?:[a-z]|\\uD834[\\uDF06-\\uDF08])&#39;</span>

<span class="nx">rewritePattern</span><span class="p">(</span><span class="s1">&#39;[\\u{1D306}-\\u{1D308}a-z]&#39;</span><span class="p">,</span> <span class="s1">&#39;ui&#39;</span><span class="p">);</span>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// In ES5, the dot operator only matches BMP symbols:</span>
