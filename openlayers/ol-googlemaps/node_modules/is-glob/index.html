...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#is-glob" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#default-behavior" title="Default behavior" class="md-nav__link">
    Default behavior
          ...
          <li class="md-nav__item">
  <a href="#option-strict" title="Option strict" class="md-nav__link">
    Option strict
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/is-glob/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="is-glob">is-glob <a href="https://www.npmjs.com/package/is-glob"><img alt="NPM version" src="https://img.shields.io/npm/v/is-glob.svg?style=flat" /></a> <a href="https://npmjs.org/package/is-glob"><img alt="NPM monthly downloads" src="https://img.shields.io/npm/dm/is-glob.svg?style=flat" /></a>  <a href="https://npmjs.org/package/is-glob"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/is-glob.svg?style=flat" /></a> <a href="https://travis-ci.org/jonschlinkert/is-glob"><img alt="Linux Build Status" src="https://img.shields.io/travis/jonschlinkert/is-glob.svg?style=flat&amp;label=Travis" /></a> <a href="https://ci.appveyor.com/project/jonschlinkert/is-glob"><img alt="Windows Build Status" src="https://img.shields.io/appveyor/ci/jonschlinkert/is-glob.svg?style=flat&amp;label=AppVeyor" /></a></h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install --save is-glob
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">isGlob</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;is-glob&#39;</span><span class="p">);</span>
</pre></div>
</td></tr></table>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;!foo.js&#39;</span><span class="p">);</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/@(a).js&#39;</span><span class="p">);</span>
...
11
12
13</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/\\@(a).js&#39;</span><span class="p">);</span>
<span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/\\!(a).js&#39;</span><span class="p">);</span>
<span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/\\+(a).js&#39;</span><span class="p">);</span>
<span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/\\*(a).js&#39;</span><span class="p">);</span>
<span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/\\?(a).js&#39;</span><span class="p">);</span>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc.js&#39;</span><span class="p">);</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">([</span><span class="s1">&#39;**/*.js&#39;</span><span class="p">]);</span>
<span class="nx">isGlob</span><span class="p">([</span><span class="s1">&#39;foo.js&#39;</span><span class="p">]);</span>
<span class="c1">//=&gt; false</span>
</pre></div>
</td></tr></table>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;!foo.js&#39;</span><span class="p">,</span> <span class="p">{</span><span class="nx">strict</span><span class="o">:</span> <span class="kc">false</span><span class="p">});</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isGlob</span><span class="p">(</span><span class="s1">&#39;abc/@(a).js&#39;</span><span class="p">,</span> <span class="p">{</span><span class="nx">strict</span><span class="o">:</span> <span class="kc">false</span><span class="p">});</span>
...
<li><a href="https://www.npmjs.com/package/base">base</a>: Framework for rapidly creating high quality node.js applications, using plugins like building blocks | <a href="https://github.com/node-base/base" title="Framework for rapidly creating high quality node.js applications, using plugins like building blocks">homepage</a></li>
