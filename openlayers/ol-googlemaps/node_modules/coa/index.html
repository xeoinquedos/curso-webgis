...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#command-option-argument" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#cmd" title="Cmd" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#cmdapi" title="Cmd.api" class="md-nav__link">
    Cmd.api
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdname" title="Cmd.name" class="md-nav__link">
    Cmd.name
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdtitle" title="Cmd.title" class="md-nav__link">
    Cmd.title
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdcmd" title="Cmd.cmd" class="md-nav__link">
    Cmd.cmd
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdopt" title="Cmd.opt" class="md-nav__link">
    Cmd.opt
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdarg" title="Cmd.arg" class="md-nav__link">
    Cmd.arg
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdact" title="Cmd.act" class="md-nav__link">
    Cmd.act
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdapply" title="Cmd.apply" class="md-nav__link">
    Cmd.apply
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdcomp" title="Cmd.comp" class="md-nav__link">
    Cmd.comp
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdhelpful" title="Cmd.helpful" class="md-nav__link">
    Cmd.helpful
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdcompletable" title="Cmd.completable" class="md-nav__link">
    Cmd.completable
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdusage" title="Cmd.usage" class="md-nav__link">
    Cmd.usage
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdrun" title="Cmd.run" class="md-nav__link">
    Cmd.run
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdinvoke" title="Cmd.invoke" class="md-nav__link">
    Cmd.invoke
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdreject" title="Cmd.reject" class="md-nav__link">
    Cmd.reject
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cmdend" title="Cmd.end" class="md-nav__link">
    Cmd.end
  </a>
          ...
          <li class="md-nav__item">
  <a href="#opt" title="Opt" class="md-nav__link">
    Opt
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#optname" title="Opt.name" class="md-nav__link">
    Opt.name
  </a>
          ...
          <li class="md-nav__item">
  <a href="#opttitle" title="Opt.title" class="md-nav__link">
    Opt.title
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optshort" title="Opt.short" class="md-nav__link">
    Opt.short
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optlong" title="Opt.long" class="md-nav__link">
    Opt.long
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optflag" title="Opt.flag" class="md-nav__link">
    Opt.flag
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optarr" title="Opt.arr" class="md-nav__link">
    Opt.arr
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optreq" title="Opt.req" class="md-nav__link">
    Opt.req
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optonly" title="Opt.only" class="md-nav__link">
    Opt.only
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optval" title="Opt.val" class="md-nav__link">
    Opt.val
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optdef" title="Opt.def" class="md-nav__link">
    Opt.def
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optinput" title="Opt.input" class="md-nav__link">
    Opt.input
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optoutput" title="Opt.output" class="md-nav__link">
    Opt.output
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optact" title="Opt.act" class="md-nav__link">
    Opt.act
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optcomp" title="Opt.comp" class="md-nav__link">
    Opt.comp
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optend" title="Opt.end" class="md-nav__link">
    Opt.end
  </a>
          ...
          <li class="md-nav__item">
  <a href="#arg" title="Arg" class="md-nav__link">
    Arg
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#argname" title="Arg.name" class="md-nav__link">
    Arg.name
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argtitle" title="Arg.title" class="md-nav__link">
    Arg.title
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argarr" title="Arg.arr" class="md-nav__link">
    Arg.arr
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argreq" title="Arg.req" class="md-nav__link">
    Arg.req
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argval" title="Arg.val" class="md-nav__link">
    Arg.val
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argdef" title="Arg.def" class="md-nav__link">
    Arg.def
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argoutput" title="Arg.output" class="md-nav__link">
    Arg.output
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argcomp" title="Arg.comp" class="md-nav__link">
    Arg.comp
  </a>
          ...
          <li class="md-nav__item">
  <a href="#argend" title="Arg.end" class="md-nav__link">
    Arg.end
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/coa/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="command-option-argument">Command-Option-Argument</h1>
<p>Yet another parser for command line options.</p>
<p><a href="https://www.npmjs.org/package/coa"><img alt="NPM Status" src="https://img.shields.io/npm/v/coa.svg" /></a>
<a href="https://travis-ci.org/veged/coa"><img alt="Travis Status" src="https://img.shields.io/travis/veged/coa.svg" /></a>
<a href="https://ci.appveyor.com/project/zxqfox/coa"><img alt="AppVeyor Status" src="https://ci.appveyor.com/api/projects/status/github/veged/coa?svg=true" /></a>
<a href="https://coveralls.io/r/veged/coa"><img alt="Coverage Status" src="https://img.shields.io/coveralls/veged/coa.svg" /></a>
<a href="https://david-dm.org/veged/coa"><img alt="Dependency Status" src="http://img.shields.io/david/veged/coa.svg" /></a></p>
...
26
27
28</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;coa&#39;</span><span class="p">).</span><span class="nx">Cmd</span><span class="p">()</span> <span class="c1">// main (top level) command declaration</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre> 1
 ...
 8
 9
10</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// subcommand.js</span>
