    ...
    Options
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss/docs/source-maps.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<li><code>from</code> string: by default, PostCSS will set the <code>sources</code> property of the map
  ...
  (<code>to</code> option in <code>process()</code> method).</li>
</ul>
