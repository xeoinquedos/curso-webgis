...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>Commander.js - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#commanderjs" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#installation" title="Installation" class="md-nav__link">
    Installation
        ...
        <li class="md-nav__item">
  <a href="#option-parsing" title="Option parsing" class="md-nav__link">
    Option parsing
  </a>
        ...
        <li class="md-nav__item">
  <a href="#version-option" title="Version option" class="md-nav__link">
    Version option
  </a>
        ...
        <li class="md-nav__item">
  <a href="#command-specific-options" title="Command-specific options" class="md-nav__link">
    Command-specific options
        ...
        <li class="md-nav__item">
  <a href="#coercion" title="Coercion" class="md-nav__link">
    Coercion
  </a>
        ...
        <li class="md-nav__item">
  <a href="#regular-expression" title="Regular Expression" class="md-nav__link">
    Regular Expression
  </a>
        ...
        <li class="md-nav__item">
  <a href="#variadic-arguments" title="Variadic arguments" class="md-nav__link">
    Variadic arguments
  </a>
        ...
        <li class="md-nav__item">
  <a href="#specify-the-argument-syntax" title="Specify the argument syntax" class="md-nav__link">
    Specify the argument syntax
        ...
        <li class="md-nav__item">
  <a href="#git-style-sub-commands" title="Git-style sub-commands" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#-harmony" title="--harmony" class="md-nav__link">
    --harmony
  </a>
        ...
        <li class="md-nav__item">
  <a href="#automated-help" title="Automated --help" class="md-nav__link">
    Automated --help
  </a>
        ...
        <li class="md-nav__item">
  <a href="#custom-help" title="Custom help" class="md-nav__link">
    Custom help
  </a>
        ...
        <li class="md-nav__item">
  <a href="#outputhelpcb" title=".outputHelp(cb)" class="md-nav__link">
    .outputHelp(cb)
  </a>
        ...
        <li class="md-nav__item">
  <a href="#helpcb" title=".help(cb)" class="md-nav__link">
    .help(cb)
  </a>
        ...
        <li class="md-nav__item">
  <a href="#custom-event-listeners" title="Custom event listeners" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/commander/Readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<a href="https://packagephobia.now.sh/result?p=commander"><img alt="Install Size" src="https://packagephobia.now.sh/badge?p=commander" /></a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install commander --save
</pre></div>
</td></tr></table>
...
19
20
21</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
13
14
15</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ ./examples/pizza -V
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">program</span>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
36
37
38</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">function</span> <span class="nx">range</span><span class="p">(</span><span class="nx">val</span><span class="p">)</span> <span class="p">{</span>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">program</span>
  <span class="p">.</span><span class="nx">version</span><span class="p">(</span><span class="s1">&#39;0.1.0&#39;</span><span class="p">)</span>
...
18
19
20</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// file: ./examples/pm</span>
<span class="kd">var</span> <span class="nx">program</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;commander&#39;</span><span class="p">);</span>
...
<em> Use <code>#! /usr/bin/env node --harmony</code> in the sub-commands scripts. Note some os version don’t support this pattern.
</em> Use the <code>--harmony</code> option when call the command, like <code>node --harmony examples/pm publish</code>. The <code>--harmony</code> option will be preserved when spawning sub-command process.</p>
...
12
13
14</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ ./examples/pizza --help
...
Options:
  ...
  -b, --bbq            Add bbq sauce
  -c, --cheese &lt;type&gt;  Add the specified <span class="nb">type</span> of cheese <span class="o">[</span>marble<span class="o">]</span>
...
26
27
28</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="ch">#!/usr/bin/env node</span>
...
12
13
14</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="n">Usage</span><span class="o">:</span> <span class="n">custom</span><span class="o">-</span><span class="n">help</span> <span class="o">[</span><span class="n">options</span><span class="o">]</span>
...
<span class="n">Options</span><span class="o">:</span>
  ...
  <span class="o">-</span><span class="n">f</span><span class="o">,</span> <span class="o">--</span><span class="n">foo</span>      <span class="n">enable</span> <span class="n">some</span> <span class="n">foo</span>
  <span class="o">-</span><span class="n">b</span><span class="o">,</span> <span class="o">--</span><span class="n">bar</span>      <span class="n">enable</span> <span class="n">some</span> <span class="n">bar</span>
  <span class="o">-</span><span class="n">B</span><span class="o">,</span> <span class="o">--</span><span class="n">baz</span>      <span class="n">enable</span> <span class="n">some</span> <span class="n">baz</span>

<span class="n">Examples</span><span class="o">:</span>

  <span class="n">$</span> <span class="n">custom</span><span class="o">-</span><span class="n">help</span> <span class="o">--</span><span class="n">help</span>
  <span class="n">$</span> <span class="n">custom</span><span class="o">-</span><span class="n">help</span> <span class="o">-</span><span class="n">h</span>
</pre></div>
</td></tr></table>
...
13
14
15</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">program</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;commander&#39;</span><span class="p">);</span>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">program</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;option:verbose&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
...
38
39
40</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">program</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;commander&#39;</span><span class="p">);</span>
