...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#postcss-minify-font-values" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#minifyfontvaluesoptions" title="minifyFontValues([options])" class="md-nav__link">
  ...
  <a href="#options" title="options" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#removeafterkeyword" title="removeAfterKeyword" class="md-nav__link">
    removeAfterKeyword
  </a>
          ...
          <li class="md-nav__item">
  <a href="#removeduplicates" title="removeDuplicates" class="md-nav__link">
    removeDuplicates
  </a>
          ...
          <li class="md-nav__item">
  <a href="#removequotes" title="removeQuotes" class="md-nav__link">
    removeQuotes
  </a>
    ...
    Usage
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/htmlnano/node_modules/postcss-minify-font-values/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-minify-font-values">postcss-minify-font-values <a href="https://travis-ci.org/TrySound/postcss-minify-font-values"><img alt="Build Status" src="https://travis-ci.org/TrySound/postcss-minify-font-values.svg" /></a></h1>
<blockquote>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">h1</span> <span class="p">{</span>
  <span class="k">font</span><span class="p">:</span><span class="kc">bold</span> <span class="mf">2.2</span><span class="kt">rem</span><span class="o">/.</span><span class="mi">9</span> <span class="s2">&quot;Open Sans Condensed&quot;</span><span class="p">,</span> <span class="kc">sans-serif</span><span class="p">;</span>
<span class="p">}</span>

<span class="nt">p</span> <span class="p">{</span>
  <span class="k">font-family</span><span class="p">:</span> <span class="s2">&quot;Helvetica Neue&quot;</span><span class="p">,</span> <span class="n">Arial</span><span class="p">,</span> <span class="kc">sans-serif</span><span class="p">,</span> <span class="n">Helvetica</span><span class="p">;</span>
...
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">h1</span> <span class="p">{</span>
  <span class="k">font</span><span class="p">:</span><span class="mi">700</span> <span class="mf">2.2</span><span class="kt">rem</span><span class="o">/.</span><span class="mi">9</span> <span class="n">Open</span> <span class="n">Sans</span> <span class="n">Condensed</span><span class="p">,</span><span class="kc">sans-serif</span>
<span class="p">}</span>

<span class="nt">p</span> <span class="p">{</span>
  <span class="k">font-family</span><span class="p">:</span> <span class="n">Helvetica</span> <span class="n">Neue</span><span class="p">,</span><span class="n">Arial</span><span class="p">,</span><span class="kc">sans-serif</span><span class="p">;</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">postcss</span><span class="p">([</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;postcss-minify-font-values&#39;</span><span class="p">)</span> <span class="p">])</span>
</pre></div>
</td></tr></table>
