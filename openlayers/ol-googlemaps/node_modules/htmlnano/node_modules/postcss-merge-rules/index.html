...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#postcss-merge-rules" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#examples" title="Examples" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#by-declarations" title="By declarations" class="md-nav__link">
    By declarations
  </a>
  ...
  <a href="#output" title="Output" class="md-nav__link">
    Output
          ...
          <li class="md-nav__item">
  <a href="#by-selectors" title="By selectors" class="md-nav__link">
    By selectors
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#input_1" title="Input" class="md-nav__link">
    Input
  </a>
  ...
  <a href="#output_1" title="Output" class="md-nav__link">
    Output
          ...
          <li class="md-nav__item">
  <a href="#by-partial-declarations" title="By partial declarations" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#input_2" title="Input" class="md-nav__link">
    Input
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/htmlnano/node_modules/postcss-merge-rules/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-merge-rules"><a href="https://github.com/postcss/postcss">postcss</a>-merge-rules <a href="https://travis-ci.org/ben-eb/postcss-merge-rules"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-merge-rules.svg?branch=master" /></a> <a href="http://badge.fury.io/js/postcss-merge-rules"><img alt="NPM version" src="https://badge.fury.io/js/postcss-merge-rules.svg" /></a> <a href="https://gemnasium.com/ben-eb/postcss-merge-rules"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/postcss-merge-rules.svg" /></a></h1>
<blockquote>
<p>Merge CSS rules with PostCSS.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>With <a href="https://npmjs.org/package/postcss-merge-rules">npm</a> do:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install postcss-merge-rules --save
</pre></div>
</td></tr></table>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span> <span class="p">{</span>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span><span class="o">,</span><span class="nt">p</span> <span class="p">{</span>
    <span class="k">color</span><span class="p">:</span> <span class="kc">blue</span><span class="p">;</span>
    <span class="k">font-weight</span><span class="p">:</span> <span class="kc">bold</span>
<span class="p">}</span>
</pre></div>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span> <span class="p">{</span>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span> <span class="p">{</span>
    <span class="k">color</span><span class="p">:</span> <span class="kc">blue</span><span class="p">;</span>
    <span class="k">font-weight</span><span class="p">:</span> <span class="kc">bold</span>
<span class="p">}</span>
</pre></div>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span> <span class="p">{</span>
    <span class="k">font-weight</span><span class="p">:</span> <span class="kc">bold</span>
<span class="p">}</span>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">a</span><span class="o">,</span><span class="nt">p</span> <span class="p">{</span>
    <span class="k">font-weight</span><span class="p">:</span> <span class="kc">bold</span>
<span class="p">}</span>
