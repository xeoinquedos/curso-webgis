...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#postcss-discard-empty" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/htmlnano/node_modules/postcss-discard-empty/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-discard-empty"><a href="https://github.com/postcss/postcss">postcss</a>-discard-empty <a href="https://travis-ci.org/ben-eb/postcss-discard-empty"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-discard-empty.svg?branch=master" /></a> <a href="http://badge.fury.io/js/postcss-discard-empty"><img alt="NPM version" src="https://badge.fury.io/js/postcss-discard-empty.svg" /></a> <a href="https://gemnasium.com/ben-eb/postcss-discard-empty"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/postcss-discard-empty.svg" /></a></h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install postcss-discard-empty --save
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">font-face</span><span class="p">;</span>
<span class="nt">h1</span> <span class="p">{}</span>
<span class="p">{</span><span class="k">color</span><span class="p">:</span><span class="kc">blue</span><span class="p">}</span>
<span class="nt">h2</span> <span class="p">{</span><span class="k">color</span><span class="p">:}</span>
<span class="nt">h3</span> <span class="p">{</span><span class="k">color</span><span class="p">:</span><span class="kc">red</span><span class="p">}</span>
</pre></div>
</td></tr></table>

<h3 id="output">Output</h3>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nt">h3</span> <span class="p">{</span><span class="k">color</span><span class="p">:</span><span class="kc">red</span><span class="p">}</span>
</pre></div>
</td></tr></table>
