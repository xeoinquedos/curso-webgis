...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#js-yaml-yaml-12-parser-writer-for-javascript" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#installation" title="Installation" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#yaml-module-for-nodejs" title="YAML module for node.js" class="md-nav__link">
    YAML module for node.js
          ...
          <li class="md-nav__item">
  <a href="#cli-executable" title="CLI executable" class="md-nav__link">
    CLI executable
  </a>
  ...
  <a href="#usage" title="Usage" class="md-nav__link">
    Usage
          ...
          <li class="md-nav__item">
  <a href="#bundled-yaml-library-for-browsers" title="Bundled YAML library for browsers" class="md-nav__link">
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#safeload-string-options" title="safeLoad (string [ , options ])" class="md-nav__link">
    safeLoad (string [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#load-string-options" title="load (string [ , options ])" class="md-nav__link">
    load (string [ , options ])
  </a>
          ...
          <li class="md-nav__item">
  <a href="#safeloadall-string-iterator-options" title="safeLoadAll (string, iterator [ , options ])" class="md-nav__link">
    safeLoadAll (string, iterator [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#loadall-string-iterator-options" title="loadAll (string, iterator [ , options ])" class="md-nav__link">
    loadAll (string, iterator [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#safedump-object-options" title="safeDump (object [ , options ])" class="md-nav__link">
    safeDump (object [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#dump-object-options" title="dump (object [ , options ])" class="md-nav__link">
    dump (object [ , options ])
  </a>
        ...
        <li class="md-nav__item">
  <a href="#supported-yaml-types" title="Supported YAML types" class="md-nav__link">
  ...
  <a href="#caveats" title="Caveats" class="md-nav__link">
    Caveats
        ...
        <li class="md-nav__item">
  <a href="#breaking-changes-in-2xx-3xx" title="Breaking changes in 2.x.x -&gt; 3.x.x" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/htmlnano/node_modules/js-yaml/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install js-yaml
</pre></div>
</td></tr></table>

<h3 id="cli-executable">CLI executable</h3>
<p>If you want to inspect your YAML files from CLI, install js-yaml globally:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install -g js-yaml
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre> 1
 ...
 8
 9
10</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="n">usage</span><span class="o">:</span> <span class="n">js</span><span class="o">-</span><span class="n">yaml</span> <span class="o">[-</span><span class="n">h</span><span class="o">]</span> <span class="o">[-</span><span class="n">v</span><span class="o">]</span> <span class="o">[-</span><span class="n">c</span><span class="o">]</span> <span class="o">[-</span><span class="n">t</span><span class="o">]</span> <span class="n">file</span>

<span class="n">Positional</span> <span class="k">arguments</span><span class="o">:</span>
  <span class="n">file</span>           <span class="n">File</span> <span class="k">with</span> <span class="n">YAML</span> <span class="n">document</span><span class="o">(</span><span class="n">s</span><span class="o">)</span>

<span class="n">Optional</span> <span class="k">arguments</span><span class="o">:</span>
  <span class="o">-</span><span class="n">h</span><span class="o">,</span> <span class="o">--</span><span class="n">help</span>     <span class="n">Show</span> <span class="k">this</span> <span class="n">help</span> <span class="n">message</span> <span class="n">and</span> <span class="n">exit</span><span class="o">.</span>
  <span class="o">-</span><span class="n">v</span><span class="o">,</span> <span class="o">--</span><span class="n">version</span>  <span class="n">Show</span> <span class="n">program</span><span class="err">&#39;</span><span class="n">s</span> <span class="n">version</span> <span class="n">number</span> <span class="n">and</span> <span class="n">exit</span><span class="o">.</span>
  <span class="o">-</span><span class="n">c</span><span class="o">,</span> <span class="o">--</span><span class="n">compact</span>  <span class="n">Display</span> <span class="n">errors</span> <span class="k">in</span> <span class="n">compact</span> <span class="n">mode</span>
  <span class="o">-</span><span class="n">t</span><span class="o">,</span> <span class="o">--</span><span class="nf">trace</span>    <span class="n">Show</span> <span class="n">stack</span> <span class="nf">trace</span> <span class="n">on</span> <span class="n">error</span>
</pre></div>
</td></tr></table>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c">&lt;!-- esprima required only for !!js/function --&gt;</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre> 1
 ...
 8
 9
10</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">yaml</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;js-yaml&#39;</span><span class="p">);</span>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">untrusted_code</span> <span class="o">=</span> <span class="s1">&#39;&quot;toString&quot;: !&lt;tag:yaml.org,2002:js/function&gt; &quot;function (){very_evil_thing();}&quot;&#39;</span><span class="p">;</span>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">yaml</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;js-yaml&#39;</span><span class="p">);</span>
...
11
12
13</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>!!null
  &quot;canonical&quot;   =&gt; &quot;~&quot;
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>!!null &#39;&#39;                   # null
!!bool &#39;yes&#39;                # bool
!!int &#39;3...&#39;                # number
!!float &#39;3.14...&#39;           # number
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>!!js/regexp /pattern/gim            # RegExp
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nn">---</span>
<span class="p p-Indicator">?</span> <span class="p p-Indicator">[</span> <span class="nv">foo</span><span class="p p-Indicator">,</span> <span class="nv">bar</span> <span class="p p-Indicator">]</span>
<span class="p p-Indicator">:</span> <span class="p p-Indicator">-</span> <span class="l l-Scalar l-Scalar-Plain">baz</span>
<span class="p p-Indicator">?</span> <span class="p p-Indicator">{</span> <span class="nv">foo</span><span class="p p-Indicator">:</span> <span class="nv">bar</span> <span class="p p-Indicator">}</span>
<span class="p p-Indicator">:</span> <span class="p p-Indicator">-</span> <span class="l l-Scalar l-Scalar-Plain">baz</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span> <span class="s2">&quot;foo,bar&quot;</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;baz&quot;</span><span class="p">],</span> <span class="s2">&quot;[object Object]&quot;</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;baz&quot;</span><span class="p">,</span> <span class="s2">&quot;baz&quot;</span><span class="p">]</span> <span class="p">}</span>
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nl">&amp;anchor</span> <span class="l l-Scalar l-Scalar-Plain">foo</span><span class="p p-Indicator">:</span>
  ...
  <span class="nv">*anchor</span><span class="p p-Indicator">:</span> <span class="l l-Scalar l-Scalar-Plain">duplicate key</span>
  <span class="l l-Scalar l-Scalar-Plain">baz</span><span class="p p-Indicator">:</span> <span class="l l-Scalar l-Scalar-Plain">bat</span>
  <span class="nv">*anchor</span><span class="p p-Indicator">:</span> <span class="l l-Scalar l-Scalar-Plain">duplicate key</span>
</pre></div>
</td></tr></table>

<h2 id="breaking-changes-in-2xx-3xx">Breaking changes in 2.x.x -&gt; 3.x.x</h2>
