...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#postcss-minify-params" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    Usage
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/htmlnano/node_modules/postcss-minify-params/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-minify-params">postcss-minify-params <a href="https://travis-ci.org/ben-eb/postcss-minify-params"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-minify-params.svg" /></a></h1>
<blockquote>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">media</span> <span class="nt">only</span> <span class="nt">screen</span>   <span class="nt">and</span> <span class="o">(</span> <span class="nt">min-width</span><span class="o">:</span> <span class="nt">400px</span><span class="o">,</span> <span class="nt">min-height</span><span class="o">:</span> <span class="nt">500px</span> <span class="o">)</span> <span class="p">{</span>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">media</span> <span class="nt">only</span> <span class="nt">screen</span> <span class="nt">and</span> <span class="o">(</span><span class="nt">min-width</span><span class="p">:</span><span class="nd">400px</span><span class="o">,</span><span class="nt">min-height</span><span class="p">:</span><span class="nd">500px</span><span class="o">)</span> <span class="p">{</span>
    <span class="nt">h2</span><span class="p">{</span>
        <span class="k">color</span><span class="p">:</span><span class="kc">blue</span>
    <span class="p">}</span>
<span class="p">}</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">postcss</span><span class="p">([</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;postcss-minify-params&#39;</span><span class="p">)</span> <span class="p">])</span>
</pre></div>
</td></tr></table>
