...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#postcss-merge-idents" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-merge-idents/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-merge-idents"><a href="https://github.com/postcss/postcss">postcss</a>-merge-idents <a href="https://travis-ci.org/ben-eb/postcss-merge-idents"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-merge-idents.svg?branch=master" /></a> <a href="http://badge.fury.io/js/postcss-merge-idents"><img alt="NPM version" src="https://badge.fury.io/js/postcss-merge-idents.svg" /></a> <a href="https://gemnasium.com/ben-eb/postcss-merge-idents"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/postcss-merge-idents.svg" /></a></h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install postcss-merge-idents --save
</pre></div>
</td></tr></table>
...
15
16
17</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">keyframes</span> <span class="nt">rotate</span> <span class="p">{</span>
    <span class="nt">from</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">360</span><span class="kt">deg</span><span class="p">)</span> <span class="p">}</span>
<span class="p">}</span>

<span class="p">@</span><span class="k">keyframes</span> <span class="nt">flip</span> <span class="p">{</span>
    <span class="nt">from</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">360</span><span class="kt">deg</span><span class="p">)</span> <span class="p">}</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">rotate</span> <span class="p">{</span>
    <span class="k">animation-name</span><span class="p">:</span> <span class="n">rotate</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">flip</span> <span class="p">{</span>
    <span class="k">animation-name</span><span class="p">:</span> <span class="kc">flip</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">keyframes</span> <span class="nt">flip</span> <span class="p">{</span>
    <span class="nt">from</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span> <span class="k">transform</span><span class="p">:</span> <span class="nb">rotate</span><span class="p">(</span><span class="mi">360</span><span class="kt">deg</span><span class="p">)</span> <span class="p">}</span>
<span class="p">}</span>
