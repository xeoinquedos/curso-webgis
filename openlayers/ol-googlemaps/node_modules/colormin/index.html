...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#colormin" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#colormincolor-options" title="colormin(color, [options])" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/colormin/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="colormin">colormin <a href="https://travis-ci.org/ben-eb/colormin"><img alt="Build Status" src="https://travis-ci.org/ben-eb/colormin.svg?branch=master" /></a> <a href="http://badge.fury.io/js/colormin"><img alt="NPM version" src="https://badge.fury.io/js/colormin.svg" /></a> <a href="https://gemnasium.com/ben-eb/colormin"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/colormin.svg" /></a></h1>
<blockquote>
<p>Turn a CSS color into its smallest representation.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>With <a href="https://npmjs.org/package/colormin">npm</a> do:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install colormin --save
</pre></div>
</td></tr></table>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">colormin</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;colormin&#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">colormin</span><span class="p">(</span><span class="s1">&#39;rgba(255, 0, 0, 1)&#39;</span><span class="p">));</span>
...
<h2 id="api">API</h2>
<h3 id="colormincolor-options">colormin(color, [options])</h3>
