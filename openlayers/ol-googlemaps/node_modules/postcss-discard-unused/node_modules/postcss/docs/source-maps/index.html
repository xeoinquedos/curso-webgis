...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>PostCSS and Source Maps - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../../#postcss-and-source-maps" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    Options
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-discard-unused/node_modules/postcss/docs/source-maps.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">processor</span>
    <span class="p">.</span><span class="nx">process</span><span class="p">(</span><span class="nx">css</span><span class="p">,</span> <span class="p">{</span>
        <span class="nx">from</span><span class="o">:</span> <span class="s1">&#39;app.sass.css&#39;</span><span class="p">,</span>
        <span class="nx">to</span><span class="o">:</span>   <span class="s1">&#39;app.css&#39;</span><span class="p">,</span>
        <span class="nx">map</span><span class="o">:</span> <span class="p">{</span> <span class="nx">inline</span><span class="o">:</span> <span class="kc">false</span> <span class="p">},</span>
    <span class="p">})</span>
...
<ul>
<li><code>inline</code> boolean: indicates that the source map should be embedded
  in the output CSS as a Base64-encoded comment. By default, it is <code>true</code>.
  But if all previous maps are external, not inline, PostCSS will not embed
  the map even if you do not set this option.</li>
</ul>
...
<ul>
<li>
<p><code>prev</code> string, object, boolean or function: source map content from
...
<li>
<p><code>sourcesContent</code> boolean: indicates that PostCSS should set the origin
...
<li>
<p><code>annotation</code> boolean or string: indicates that PostCSS should add annotation
...
<ul>
<li><code>from</code> string: by default, PostCSS will set the <code>sources</code> property of the map
  to the value of the <code>from</code> option. If you want to override this behaviour, you
  can use <code>map.from</code> to explicitly set the source map's <code>sources</code> property.</li>
</ul>
