...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>PostCSS Plugin Guidelines - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../../../#postcss-plugin-guidelines" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#1-api" title="1. API" class="md-nav__link">
    1. API
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#11-clear-name-with-postcss-prefix" title="1.1 Clear name with postcss- prefix" class="md-nav__link">
    1.1 Clear name with postcss- prefix
          ...
          <li class="md-nav__item">
  <a href="#12-do-one-thing-and-do-it-well" title="1.2. Do one thing, and do it well" class="md-nav__link">
    1.2. Do one thing, and do it well
          ...
          <li class="md-nav__item">
  <a href="#13-do-not-use-mixins" title="1.3. Do not use mixins" class="md-nav__link">
    1.3. Do not use mixins
          ...
          <li class="md-nav__item">
  <a href="#14-create-plugin-by-postcssplugin" title="1.4. Create plugin by postcss.plugin" class="md-nav__link">
    1.4. Create plugin by postcss.plugin
        ...
        <li class="md-nav__item">
  <a href="#2-processing" title="2. Processing" class="md-nav__link">
    2. Processing
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#21-plugin-must-be-tested" title="2.1. Plugin must be tested" class="md-nav__link">
    2.1. Plugin must be tested
          ...
          <li class="md-nav__item">
  <a href="#22-use-asynchronous-methods-whenever-possible" title="2.2. Use asynchronous methods whenever possible" class="md-nav__link">
    2.2. Use asynchronous methods whenever possible
          ...
          <li class="md-nav__item">
  <a href="#23-set-nodesource-for-new-nodes" title="2.3. Set node.source for new nodes" class="md-nav__link">
    2.3. Set node.source for new nodes
          ...
          <li class="md-nav__item">
  <a href="#24-use-only-the-public-postcss-api" title="2.4. Use only the public PostCSS API" class="md-nav__link">
    2.4. Use only the public PostCSS API
        ...
        <li class="md-nav__item">
  <a href="#3-errors" title="3. Errors" class="md-nav__link">
    3. Errors
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#31-use-nodeerror-on-css-relevant-errors" title="3.1. Use node.error on CSS relevant errors" class="md-nav__link">
    3.1. Use node.error on CSS relevant errors
          ...
          <li class="md-nav__item">
  <a href="#32-use-resultwarn-for-warnings" title="3.2. Use result.warn for warnings" class="md-nav__link">
    3.2. Use result.warn for warnings
        ...
        <li class="md-nav__item">
  <a href="#4-documentation" title="4. Documentation" class="md-nav__link">
    4. Documentation
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#41-document-your-plugin-in-english" title="4.1. Document your plugin in English" class="md-nav__link">
    4.1. Document your plugin in English
          ...
          <li class="md-nav__item">
  <a href="#42-include-input-and-output-examples" title="4.2. Include input and output examples" class="md-nav__link">
    4.2. Include input and output examples
          ...
          <li class="md-nav__item">
  <a href="#43-maintain-a-changelog" title="4.3. Maintain a changelog" class="md-nav__link">
    4.3. Maintain a changelog
          ...
          <li class="md-nav__item">
  <a href="#44-include-postcss-plugin-keyword-in-packagejson" title="4.4. Include postcss-plugin keyword in package.json" class="md-nav__link">
    4.4. Include postcss-plugin keyword in package.json
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-discard-unused/node_modules/postcss/docs/guidelines/plugin.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<h3 id="11-clear-name-with-postcss-prefix">1.1 Clear name with <code>postcss-</code> prefix</h3>
...
<h3 id="14-create-plugin-by-postcssplugin">1.4. Create plugin by <code>postcss.plugin</code></h3>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">postcss</span><span class="p">.</span><span class="nx">plugin</span><span class="p">(</span><span class="s1">&#39;plugin-name&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">opts</span><span class="p">)</span> <span class="p">{</span>
...
11
12
13</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">postcss</span><span class="p">.</span><span class="nx">plugin</span><span class="p">(</span><span class="s1">&#39;plugin-sprite&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">opts</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">root</span><span class="p">,</span> <span class="nx">result</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="23-set-nodesource-for-new-nodes">2.3. Set <code>node.source</code> for new nodes</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">if</span> <span class="p">(</span> <span class="nx">needPrefix</span><span class="p">(</span><span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span><span class="p">)</span> <span class="p">)</span> <span class="p">{</span>
    <span class="nx">decl</span><span class="p">.</span><span class="nx">cloneBefore</span><span class="p">({</span> <span class="nx">prop</span><span class="o">:</span> <span class="s1">&#39;-webkit-&#39;</span> <span class="o">+</span> <span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span> <span class="p">});</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">if</span> <span class="p">(</span> <span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span> <span class="o">===</span> <span class="s1">&#39;animation&#39;</span> <span class="p">)</span> <span class="p">{</span>
...
<h3 id="31-use-nodeerror-on-css-relevant-errors">3.1. Use <code>node.error</code> on CSS relevant errors</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">if</span> <span class="p">(</span> <span class="k">typeof</span> <span class="nx">mixins</span><span class="p">[</span><span class="nx">name</span><span class="p">]</span> <span class="o">===</span> <span class="s1">&#39;undefined&#39;</span> <span class="p">)</span> <span class="p">{</span>
    <span class="k">throw</span> <span class="nx">decl</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Unknown mixin &#39;</span> <span class="o">+</span> <span class="nx">name</span><span class="p">,</span> <span class="p">{</span> <span class="nx">plugin</span><span class="o">:</span> <span class="s1">&#39;postcss-mixins&#39;</span> <span class="p">});</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>

<h3 id="32-use-resultwarn-for-warnings">3.2. Use <code>result.warn</code> for warnings</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">if</span> <span class="p">(</span> <span class="nx">outdated</span><span class="p">(</span><span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span><span class="p">)</span> <span class="p">)</span> <span class="p">{</span>
    <span class="nx">result</span><span class="p">.</span><span class="nx">warn</span><span class="p">(</span><span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span> <span class="o">+</span> <span class="s1">&#39; is outdated&#39;</span><span class="p">,</span> <span class="p">{</span> <span class="nx">node</span><span class="o">:</span> <span class="nx">decl</span> <span class="p">});</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
<h3 id="44-include-postcss-plugin-keyword-in-packagejson">4.4. Include <code>postcss-plugin</code> keyword in <code>package.json</code></h3>
