...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>PostCSS Runner Guidelines - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../../../#postcss-runner-guidelines" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#1-api" title="1. API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#11-accept-functions-in-plugin-parameters" title="1.1. Accept functions in plugin parameters" class="md-nav__link">
  ...
  <a href="#2-processing" title="2. Processing" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#21-set-from-and-to-processing-options" title="2.1. Set from and to processing options" class="md-nav__link">
    2.1. Set from and to processing options
          ...
          <li class="md-nav__item">
  <a href="#22-use-only-the-asynchronous-api" title="2.2. Use only the asynchronous API" class="md-nav__link">
    2.2. Use only the asynchronous API
          ...
          <li class="md-nav__item">
  <a href="#23-use-only-the-public-postcss-api" title="2.3. Use only the public PostCSS API" class="md-nav__link">
    2.3. Use only the public PostCSS API
        ...
        <li class="md-nav__item">
  <a href="#3-output" title="3. Output" class="md-nav__link">
    3. Output
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#31-dont-show-js-stack-for-csssyntaxerror" title="3.1. Don’t show JS stack for CssSyntaxError" class="md-nav__link">
    3.1. Don’t show JS stack for CssSyntaxError
          ...
          <li class="md-nav__item">
  <a href="#32-display-resultwarnings" title="3.2. Display result.warnings()" class="md-nav__link">
    3.2. Display result.warnings()
          ...
          <li class="md-nav__item">
  <a href="#33-allow-the-user-to-write-source-maps-to-different-files" title="3.3. Allow the user to write source maps to different files" class="md-nav__link">
  ...
  <a href="#4-documentation" title="4. Documentation" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#41-document-your-runner-in-english" title="4.1. Document your runner in English" class="md-nav__link">
    4.1. Document your runner in English
          ...
          <li class="md-nav__item">
  <a href="#42-maintain-a-changelog" title="4.2. Maintain a changelog" class="md-nav__link">
    4.2. Maintain a changelog
          ...
          <li class="md-nav__item">
  <a href="#43-postcss-runner-keyword-in-packagejson" title="4.3. postcss-runner keyword in package.json" class="md-nav__link">
    4.3. postcss-runner keyword in package.json
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-discard-unused/node_modules/postcss/docs/guidelines/runner.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="p">[</span>
    <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;postcss-assets&#39;</span><span class="p">)({</span>
        <span class="nx">cachebuster</span><span class="o">:</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">file</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="21-set-from-and-to-processing-options">2.1. Set <code>from</code> and <code>to</code> processing options</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">processor</span><span class="p">.</span><span class="nx">process</span><span class="p">({</span> <span class="nx">from</span><span class="o">:</span> <span class="nx">file</span><span class="p">.</span><span class="nx">path</span><span class="p">,</span> <span class="nx">to</span><span class="o">:</span> <span class="nx">file</span><span class="p">.</span><span class="nx">path</span> <span class="p">});</span>
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">processor</span><span class="p">.</span><span class="nx">process</span><span class="p">(</span><span class="nx">opts</span><span class="p">).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">result</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="31-dont-show-js-stack-for-csssyntaxerror">3.1. Don’t show JS stack for <code>CssSyntaxError</code></h3>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">processor</span><span class="p">.</span><span class="nx">process</span><span class="p">(</span><span class="nx">opts</span><span class="p">).</span><span class="k">catch</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">error</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="32-display-resultwarnings">3.2. Display <code>result.warnings()</code></h3>
<p>PostCSS runners must output warnings from <code>result.warnings()</code>:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">result</span><span class="p">.</span><span class="nx">warnings</span><span class="p">().</span><span class="nx">forEach</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">warn</span><span class="p">)</span> <span class="p">{</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">if</span> <span class="p">(</span> <span class="nx">result</span><span class="p">.</span><span class="nx">map</span> <span class="p">)</span> <span class="p">{</span>
...
<h3 id="43-postcss-runner-keyword-in-packagejson">4.3. <code>postcss-runner</code> keyword in <code>package.json</code></h3>
