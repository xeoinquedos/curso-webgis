...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>How to Write Custom Syntax - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../../#how-to-write-custom-syntax" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#parser" title="Parser" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#main-theory" title="Main Theory" class="md-nav__link">
    Main Theory
  </a>
  ...
  <a href="#performance" title="Performance" class="md-nav__link">
    Performance
          ...
          <li class="md-nav__item">
  <a href="#node-source" title="Node Source" class="md-nav__link">
    Node Source
  </a>
          ...
          <li class="md-nav__item">
  <a href="#raw-values" title="Raw Values" class="md-nav__link">
    Raw Values
  </a>
  ...
  <a href="#tests" title="Tests" class="md-nav__link">
    Tests
        ...
        <li class="md-nav__item">
  <a href="#stringifier" title="Stringifier" class="md-nav__link">
    Stringifier
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#main-theory_1" title="Main Theory" class="md-nav__link">
    Main Theory
  </a>
          ...
          <li class="md-nav__item">
  <a href="#builder-function" title="Builder Function" class="md-nav__link">
    Builder Function
  </a>
          ...
          <li class="md-nav__item">
  <a href="#raw-values_1" title="Raw Values" class="md-nav__link">
    Raw Values
  </a>
    ...
    Tests
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-discard-unused/node_modules/postcss/docs/syntax.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">postcss</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;postcss&#39;</span><span class="p">);</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// Slow</span>
...
<span class="kr">const</span> <span class="nx">OPEN_CURLY</span> <span class="o">=</span> <span class="mi">123</span><span class="p">;</span> <span class="c1">// `{&#39;</span>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// Simple jump</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">root</span><span class="p">,</span> <span class="nx">builder</span><span class="p">)</span> <span class="p">{</span>
...
<h3 id="main-theory_1">Main Theory</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">this</span><span class="p">.</span><span class="nx">builder</span><span class="p">(</span><span class="nx">rule</span><span class="p">.</span><span class="nx">selector</span> <span class="o">+</span> <span class="s1">&#39;{&#39;</span><span class="p">,</span> <span class="nx">rule</span><span class="p">,</span> <span class="s1">&#39;start&#39;</span><span class="p">);</span>
...
<h3 id="raw-values_1">Raw Values</h3>
