...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>parse-json [![Build Status](https://travis-ci.org/sindresorhus/parse-json.svg?branch=master)](https://travis-ci.org/sindresorhus/parse-json) - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#parse-json" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#parsejsoninput-reviver-filename" title="parseJson(input, [reviver], [filename])" class="md-nav__link">
  ...
  <a href="#input" title="input" class="md-nav__link">
    input
          ...
          <li class="md-nav__item">
  <a href="#reviver" title="reviver" class="md-nav__link">
    reviver
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/parse-json/readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install parse-json
</pre></div>
</td></tr></table>
...
39
40
41</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">const</span> <span class="nx">parseJson</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;parse-json&#39;</span><span class="p">);</span>
<span class="kr">const</span> <span class="nx">json</span> <span class="o">=</span> <span class="s1">&#39;{\n\t&quot;foo&quot;: true,\n}&#39;</span><span class="p">;</span>
...
<span class="nx">parseJson</span><span class="p">(</span><span class="nx">json</span><span class="p">,</span> <span class="s1">&#39;foo.json&#39;</span><span class="p">);</span>
<span class="cm">/*</span>
<span class="cm">JSONError: Trailing comma in object in foo.json:3:1</span>
<span class="cm">}</span>
<span class="cm">^</span>
<span class="cm">*/</span>
...
<span class="p">}</span> <span class="k">catch</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">err</span><span class="p">.</span><span class="nx">fileName</span> <span class="o">=</span> <span class="s1">&#39;foo.json&#39;</span><span class="p">;</span>
