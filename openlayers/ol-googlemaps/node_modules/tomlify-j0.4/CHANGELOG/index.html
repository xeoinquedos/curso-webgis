...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#v300" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#v300" title="v3.0.0" class="md-nav__link">
    v3.0.0
  </a>
    ...
    v2.0.0
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/tomlify-j0.4/CHANGELOG.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<ul>
<li>New API interface: <code>tomlify.toToml(obj, opts)</code>, <code>tomlify.toValue(obj, opts)</code>.
  <code>tomlify</code> is no longer a function. (incompatible changes)</li>
<li>New option <code>sort</code> to specify a compare function for sorting table keys.</li>
</ul>
<h3 id="v211">v2.1.1</h3>
<ul>
<li>New API <code>tomlify.toToml()</code>.</li>
<li>Check for circular data structure in <code>tomlify.toValue()</code>.</li>
</ul>
<h3 id="v200">v2.0.0</h3>
<p>Breaking change:</p>
<ul>
<li>In any case, do not indent array elements when <code>space</code> is empty.</li>
<li>Now <code>tomlify.toValue</code> always make every inline-table fit into one line.</li>
</ul>
