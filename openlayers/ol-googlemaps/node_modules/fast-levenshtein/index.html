...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#fast-levenshtein-levenshtein-algorithm-in-javascript" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#examples" title="Examples" class="md-nav__link">
    Examples
        ...
        <li class="md-nav__item">
  <a href="#building-and-testing" title="Building and Testing" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/fast-levenshtein/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install fast-levenshtein
</pre></div>
</td></tr></table>

<h3 id="browser">Browser</h3>
<p>Using bower:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ bower install fast-levenshtein
</pre></div>
</td></tr></table>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">levenshtein</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fast-levenshtein&#39;</span><span class="p">);</span>
...
<span class="nx">levenshtein</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;mikailovitch&#39;</span><span class="p">,</span> <span class="s1">&#39;Mikhaïlovitch&#39;</span><span class="p">,</span> <span class="p">{</span> <span class="nx">useCollator</span><span class="o">:</span> <span class="kc">true</span><span class="p">});</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install -g grunt-cli
$ npm install
$ npm run build
</pre></div>
</td></tr></table>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>Running suite Implementation comparison <span class="o">[</span>benchmark/speed.js<span class="o">]</span>...
&gt;&gt; levenshtein-edit-distance x <span class="m">234</span> ops/sec ±3.02% <span class="o">(</span><span class="m">73</span> runs sampled<span class="o">)</span>
&gt;&gt; levenshtein-component x <span class="m">422</span> ops/sec ±4.38% <span class="o">(</span><span class="m">83</span> runs sampled<span class="o">)</span>
&gt;&gt; levenshtein-deltas x <span class="m">283</span> ops/sec ±3.83% <span class="o">(</span><span class="m">78</span> runs sampled<span class="o">)</span>
&gt;&gt; natural x <span class="m">255</span> ops/sec ±0.76% <span class="o">(</span><span class="m">88</span> runs sampled<span class="o">)</span>
&gt;&gt; levenshtein x <span class="m">180</span> ops/sec ±3.55% <span class="o">(</span><span class="m">86</span> runs sampled<span class="o">)</span>
&gt;&gt; fast-levenshtein x <span class="m">1</span>,792 ops/sec ±2.72% <span class="o">(</span><span class="m">95</span> runs sampled<span class="o">)</span>
Benchmark <span class="k">done</span>.
Fastest <span class="nb">test</span> is fast-levenshtein at <span class="m">4</span>.2x faster than levenshtein-component
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install
$ npm run build
$ npm run benchmark
</pre></div>
</td></tr></table>
