...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-merge-longhand/CHANGELOG.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<h1 id="300">3.0.0</h1>
<ul>
<li>Rewrote the module, with lots of bug fixes and improvements to longhand
  merging (thanks to @andyjansson).</li>
<li>Now supports merging <code>column-width</code> &amp; <code>column-count</code> into <code>columns</code>.</li>
<li>Now supports merging <code>border-left-width</code> (plus the other 3) into
  <code>border-width</code>, where the previous behaviour would merge them into <code>border</code>.</li>
<li>Now supports merging single longhand properties into the shorthand, e.g.
  <code>padding: 2px;padding-top: 5px</code> becomes <code>padding: 5px 2px 2px</code>.</li>
<li>Better support for browser hacks; the module will not merge properties when
  they have browser hacks applied.</li>
</ul>
<h1 id="202">2.0.2</h1>
<ul>
