...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#unset-value" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#examples" title="Examples" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#updates-the-object-when-a-property-is-deleted" title="Updates the object when a property is deleted" class="md-nav__link">
    Updates the object when a property is deleted
          ...
          <li class="md-nav__item">
  <a href="#returns-true-when-a-property-is-deleted" title="Returns true when a property is deleted" class="md-nav__link">
    Returns true when a property is deleted
          ...
          <li class="md-nav__item">
  <a href="#returns-true-when-a-property-does-not-exist" title="Returns true when a property does not exist" class="md-nav__link">
    Returns true when a property does not exist
          ...
          <li class="md-nav__item">
  <a href="#delete-nested-values" title="delete nested values" class="md-nav__link">
    delete nested values
          ...
          <li class="md-nav__item">
  <a href="#throws-on-invalid-args" title="throws on invalid args" class="md-nav__link">
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/unset-value/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="unset-value">unset-value <a href="https://www.npmjs.com/package/unset-value"><img alt="NPM version" src="https://img.shields.io/npm/v/unset-value.svg?style=flat" /></a> <a href="https://npmjs.org/package/unset-value"><img alt="NPM monthly downloads" src="https://img.shields.io/npm/dm/unset-value.svg?style=flat" /></a>  <a href="https://npmjs.org/package/unset-value"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/unset-value.svg?style=flat" /></a> <a href="https://travis-ci.org/jonschlinkert/unset-value"><img alt="Linux Build Status" src="https://img.shields.io/travis/jonschlinkert/unset-value.svg?style=flat&amp;label=Travis" /></a></h1>
<blockquote>
<p>Delete nested properties from an object using dot notation.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>Install with <a href="https://www.npmjs.com/">npm</a>:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install --save unset-value
</pre></div>
</td></tr></table>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">unset</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;unset-value&#39;</span><span class="p">);</span>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">obj</span> <span class="o">=</span> <span class="p">{</span><span class="nx">a</span><span class="o">:</span> <span class="s1">&#39;b&#39;</span><span class="p">};</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">unset</span><span class="p">({</span><span class="nx">a</span><span class="o">:</span> <span class="s1">&#39;b&#39;</span><span class="p">},</span> <span class="s1">&#39;a&#39;</span><span class="p">)</span> <span class="c1">// true</span>
</pre></div>
</td></tr></table>

<h3 id="returns-true-when-a-property-does-not-exist">Returns <code>true</code> when a property does not exist</h3>
<p>This is consistent with <code>delete</code> behavior in that it does not
throw when a property does not exist.</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">unset</span><span class="p">({</span><span class="nx">a</span><span class="o">:</span> <span class="p">{</span><span class="nx">b</span><span class="o">:</span> <span class="p">{</span><span class="nx">c</span><span class="o">:</span> <span class="s1">&#39;d&#39;</span><span class="p">}}},</span> <span class="s1">&#39;d&#39;</span><span class="p">)</span> <span class="c1">// true</span>
</pre></div>
</td></tr></table>
...
12
13
14</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">one</span> <span class="o">=</span> <span class="p">{</span><span class="nx">a</span><span class="o">:</span> <span class="p">{</span><span class="nx">b</span><span class="o">:</span> <span class="p">{</span><span class="nx">c</span><span class="o">:</span> <span class="s1">&#39;d&#39;</span><span class="p">}}};</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">unset</span><span class="p">();</span>
