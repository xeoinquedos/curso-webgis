...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#babel-plugin-transform-es2015-parameters" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    Via Node API
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/babel-plugin-transform-es2015-parameters/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="babel-plugin-transform-es2015-parameters">babel-plugin-transform-es2015-parameters</h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install --save-dev babel-plugin-transform-es2015-parameters
</pre></div>
</td></tr></table>

<h2 id="caveats">Caveats</h2>
<p>Default parameters desugar into <code>let</code> declarations to retain proper semantics. If this is
not supported in your environment then you'll need the
<a href="http://babeljs.io/docs/plugins/transform-es2015-block-scoping">transform-block-scoping</a> plugin.</p>
...
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;plugins&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-parameters&quot;</span><span class="p">]</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>

<h3 id="via-cli">Via CLI</h3>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>babel --plugins transform-es2015-parameters script.js
</pre></div>
</td></tr></table>
...
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;babel-core&quot;</span><span class="p">).</span><span class="nx">transform</span><span class="p">(</span><span class="s2">&quot;code&quot;</span><span class="p">,</span> <span class="p">{</span>
  <span class="nx">plugins</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-parameters&quot;</span><span class="p">]</span>
<span class="p">});</span>
</pre></div>
</td></tr></table>
