...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#is-data-descriptor" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#examples" title="Examples" class="md-nav__link">
    Examples
        ...
        <li class="md-nav__item">
  <a href="#valid-properties" title="Valid properties" class="md-nav__link">
    Valid properties
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/snapdragon-node/node_modules/is-data-descriptor/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="is-data-descriptor">is-data-descriptor <a href="https://www.npmjs.com/package/is-data-descriptor"><img alt="NPM version" src="https://img.shields.io/npm/v/is-data-descriptor.svg?style=flat" /></a> <a href="https://npmjs.org/package/is-data-descriptor"><img alt="NPM monthly downloads" src="https://img.shields.io/npm/dm/is-data-descriptor.svg?style=flat" /></a> <a href="https://npmjs.org/package/is-data-descriptor"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/is-data-descriptor.svg?style=flat" /></a> <a href="https://travis-ci.org/jonschlinkert/is-data-descriptor"><img alt="Linux Build Status" src="https://img.shields.io/travis/jonschlinkert/is-data-descriptor.svg?style=flat&amp;label=Travis" /></a></h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install --save is-data-descriptor
</pre></div>
</td></tr></table>

<h2 id="usage">Usage</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">isDataDesc</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;is-data-descriptor&#39;</span><span class="p">);</span>
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// `value` can be anything</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isDataDesc</span><span class="p">(</span><span class="s1">&#39;a&#39;</span><span class="p">)</span>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isDataDesc</span><span class="p">({</span><span class="nx">value</span><span class="o">:</span> <span class="s1">&#39;foo&#39;</span><span class="p">,</span> <span class="nx">bar</span><span class="o">:</span> <span class="s1">&#39;baz&#39;</span><span class="p">})</span>
<span class="c1">//=&gt; false</span>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">isDataDesc</span><span class="p">({</span><span class="nx">value</span><span class="o">:</span> <span class="s1">&#39;foo&#39;</span><span class="p">,</span> <span class="nx">enumerable</span><span class="o">:</span> <span class="s1">&#39;foo&#39;</span><span class="p">})</span>
<span class="c1">//=&gt; false</span>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">foo</span> <span class="o">=</span> <span class="p">{};</span>
