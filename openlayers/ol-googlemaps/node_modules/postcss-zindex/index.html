...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#postcss-zindex" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#zindexoptions" title="zindex([options])" class="md-nav__link">
    zindex([options])
  </a>
  ...
  <a href="#options" title="options" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#startindex" title="startIndex" class="md-nav__link">
    startIndex
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-zindex/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-zindex"><a href="https://github.com/postcss/postcss">postcss</a>-zindex <a href="https://travis-ci.org/ben-eb/postcss-zindex"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-zindex.svg?branch=master" /></a> <a href="http://badge.fury.io/js/postcss-zindex"><img alt="NPM version" src="https://badge.fury.io/js/postcss-zindex.svg" /></a> <a href="https://gemnasium.com/ben-eb/postcss-zindex"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/postcss-zindex.svg" /></a></h1>
<blockquote>
<p>Reduce z-index values with PostCSS.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>With <a href="https://npmjs.org/package/postcss-zindex">npm</a> do:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install postcss-zindex --save
</pre></div>
</td></tr></table>
...
5
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">.</span><span class="nc">modal</span> <span class="p">{</span>
    <span class="k">z-index</span><span class="p">:</span> <span class="mi">5000</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">modal-overlay</span> <span class="p">{</span>
    <span class="k">z-index</span><span class="p">:</span> <span class="mi">5500</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
6
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">.</span><span class="nc">modal</span> <span class="p">{</span>
    <span class="k">z-index</span><span class="p">:</span> <span class="mi">1</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">modal-overlay</span> <span class="p">{</span>
    <span class="k">z-index</span><span class="p">:</span> <span class="mi">2</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
