...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>Contributing - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#adding-a-new-plugin-to-support-when-approved-in-the-next-ecmascript-version" title="Adding a new plugin to support (when approved in the next ECMAScript version)" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#update-plugin-featuresjs" title="Update plugin-features.js" class="md-nav__link">
    Update plugin-features.js
          ...
          <li class="md-nav__item">
  <a href="#update-built-in-featuresjs" title="Update built-in-features.js" class="md-nav__link">
    Update built-in-features.js
          ...
          <li class="md-nav__item">
  <a href="#update-pluginsjson" title="Update plugins.json" class="md-nav__link">
    Update plugins.json
  </a>
  ...
  <a href="#tests" title="Tests" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#running-tests-locally" title="Running tests locally" class="md-nav__link">
    Running tests locally
          ...
          <li class="md-nav__item">
  <a href="#checking-code-coverage-locally" title="Checking code coverage locally" class="md-nav__link">
  ...
  <a href="#general" title="General" class="md-nav__link">
    General
          ...
          <li class="md-nav__item">
  <a href="#testing-the-debug-option" title="Testing the debug option" class="md-nav__link">
    Testing the debug option
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/babel-preset-env/CONTRIBUTING.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="contributing">Contributing</h1>
<h2 id="adding-a-new-plugin-to-support-when-approved-in-the-next-ecmascript-version">Adding a new plugin to support (when approved in the next ECMAScript version)</h2>
<h3 id="update-plugin-featuresjs">Update <a href="https://github.com/babel/babel-preset-env/blob/master/data/plugin-features.js"><code>plugin-features.js</code></a></h3>
<p><em>Example:</em></p>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="c1">// es2016</span>
<span class="s2">&quot;transform-exponentiation-operator&quot;</span><span class="o">:</span> <span class="p">{</span>
  <span class="nx">features</span><span class="o">:</span> <span class="p">[</span>
    <span class="s2">&quot;exponentiation (**) operator&quot;</span><span class="p">,</span>
  <span class="p">],</span>
<span class="p">},</span>
</pre></div>
</td></tr></table>

<h3 id="update-built-in-featuresjs">Update <a href="https://github.com/babel/babel-preset-env/blob/master/data/built-in-features.js"><code>built-in-features.js</code></a></h3>
<p><em>Example:</em></p>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">const</span> <span class="nx">es2017</span> <span class="o">=</span> <span class="p">{</span>
  <span class="c1">//...</span>
  <span class="s2">&quot;es7.object.values&quot;</span><span class="o">:</span> <span class="s2">&quot;Object static methods / Object.values&quot;</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>

<h3 id="update-pluginsjson">Update <a href="https://github.com/babel/babel-preset-env/blob/master/data/plugins.json"><code>plugins.json</code></a></h3>
...
<h3 id="checking-code-coverage-locally">Checking code coverage locally</h3>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm run coverage
</pre></div>
</td></tr></table>
...
<h4 id="testing-the-debug-option">Testing the <code>debug</code> option</h4>
