...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#node-url" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="api" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#urlparseurlstr-parsequerystring-slashesdenotehost" title="url.parse(urlStr, [parseQueryString], [slashesDenoteHost])" class="md-nav__link">
    url.parse(urlStr, [parseQueryString], [slashesDenoteHost])
          ...
          <li class="md-nav__item">
  <a href="#urlformaturlobj" title="url.format(urlObj)" class="md-nav__link">
    url.format(urlObj)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#urlresolvefrom-to" title="url.resolve(from, to)" class="md-nav__link">
    url.resolve(from, to)
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/url/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="node-url">node-url</h1>
<p><a href="https://travis-ci.org/defunctzombie/node-url"><img alt="Build Status" src="https://travis-ci.org/defunctzombie/node-url.svg?branch=master" /></a></p>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">url</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;url&#39;</span><span class="p">);</span>
</pre></div>
</td></tr></table>
...
<li>
<p><code>host</code>: The full lowercased host portion of the URL, including port
  information.</p>
...
<li>
<p><code>pathname</code>: The path section of the URL, that comes after the host and
  before the query, including the initial slash if present.</p>
<p>Example: <code>'/p/a/t/h'</code></p>
</li>
<li>
<p><code>search</code>: The 'query string' portion of the URL, including the leading
  question mark.</p>
...
<li>
<p><code>query</code>: Either the 'params' portion of the query string, or a
...
<h3 id="urlparseurlstr-parsequerystring-slashesdenotehost">url.parse(urlStr, [parseQueryString], [slashesDenoteHost])</h3>
...
<h3 id="urlformaturlobj">url.format(urlObj)</h3>
<p>Take a parsed URL object, and return a formatted URL string.</p>
<ul>
<li><code>href</code> will be ignored.</li>
<li><code>protocol</code> is treated the same with or without the trailing <code>:</code> (colon).</li>
...
<h3 id="urlresolvefrom-to">url.resolve(from, to)</h3>
<p>Take a base URL, and a href URL, and resolve them as a browser would for
an anchor tag.  Examples:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>url.resolve(&#39;/one/two/three&#39;, &#39;four&#39;)         // &#39;/one/two/four&#39;
