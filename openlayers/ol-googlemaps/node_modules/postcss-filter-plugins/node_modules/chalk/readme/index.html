...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../#why" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#chalkstylestylestring-string" title="chalk.&lt;style&gt;[.&lt;style&gt;...](string, [string...])" class="md-nav__link">
    chalk.&lt;style&gt;[.&lt;style&gt;...](string, [string...])
          ...
          <li class="md-nav__item">
  <a href="#chalkenabled" title="chalk.enabled" class="md-nav__link">
    chalk.enabled
  </a>
          ...
          <li class="md-nav__item">
  <a href="#chalksupportscolor" title="chalk.supportsColor" class="md-nav__link">
    chalk.supportsColor
  </a>
          ...
          <li class="md-nav__item">
  <a href="#chalkstyles" title="chalk.styles" class="md-nav__link">
    chalk.styles
  </a>
          ...
          <li class="md-nav__item">
  <a href="#chalkhascolorstring" title="chalk.hasColor(string)" class="md-nav__link">
    chalk.hasColor(string)
          ...
          <li class="md-nav__item">
  <a href="#chalkstripcolorstring" title="chalk.stripColor(string)" class="md-nav__link">
  ...
  <a href="#styles" title="Styles" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#modifiers" title="Modifiers" class="md-nav__link">
    Modifiers
  </a>
  ...
  <a href="#colors" title="Colors" class="md-nav__link">
    Colors
          ...
          <li class="md-nav__item">
  <a href="#background-colors" title="Background colors" class="md-nav__link">
    Background colors
  </a>
        ...
        <li class="md-nav__item">
  <a href="#256-colors" title="256-colors" class="md-nav__link">
    256-colors
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-filter-plugins/node_modules/chalk/readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<a href="https://www.youtube.com/watch?v=9auOCbH5Ns4"><img alt="" src="http://img.shields.io/badge/unicorn-approved-ff69b4.svg" /></a></p>
...
<p><img alt="" src="https://github.com/chalk/ansi-styles/raw/master/screenshot.png" /></p>
<h2 id="why">Why</h2>
<ul>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install --save chalk
</pre></div>
</td></tr></table>
...
21
22
23</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">chalk</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;chalk&#39;</span><span class="p">);</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">chalk</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;chalk&#39;</span><span class="p">);</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">name</span> <span class="o">=</span> <span class="s1">&#39;Sindre&#39;</span><span class="p">;</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">ctx</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">chalk</span><span class="p">.</span><span class="nx">constructor</span><span class="p">({</span><span class="nx">enabled</span><span class="o">:</span> <span class="kc">false</span><span class="p">});</span>
</pre></div>
</td></tr></table>
...
<h3 id="chalkstyles">chalk.styles</h3>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">chalk</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;chalk&#39;</span><span class="p">);</span>
...
<h3 id="chalkhascolorstring">chalk.hasColor(string)</h3>
<p>Check whether a string <a href="https://github.com/chalk/has-ansi">has color</a>.</p>
<h3 id="chalkstripcolorstring">chalk.stripColor(string)</h3>
