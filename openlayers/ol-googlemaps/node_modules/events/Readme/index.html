...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>events [![Build Status](https://travis-ci.org/Gozala/events.png?branch=master)](https://travis-ci.org/Gozala/events) - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#install" title="Install" class="md-nav__link">
    Install
        ...
        <li class="md-nav__item">
  <a href="#require" title="Require" class="md-nav__link">
    Require
  </a>
    ...
    Usage
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/events/Readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="events">events <a href="https://travis-ci.org/Gozala/events"><img alt="Build Status" src="https://travis-ci.org/Gozala/events.png?branch=master" /></a></h1>
<p>Node's event emitter for all engines.</p>
<h2 id="install">Install</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install events
</pre></div>
</td></tr></table>

<h2 id="require">Require</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">EventEmitter</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;events&#39;</span><span class="p">).</span><span class="nx">EventEmitter</span>
</pre></div>
</td></tr></table>
