...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>stream-browserify - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#stream-browserify" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/stream-browserify/readme.markdown" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="stream-browserify">stream-browserify</h1>
<p>the stream module from node core, for browsers!</p>
<p><a href="http://travis-ci.org/substack/stream-browserify"><img alt="build status" src="https://secure.travis-ci.org/substack/stream-browserify.svg" /></a></p>
<h1 id="methods">methods</h1>
<p>Consult the node core
<a href="http://nodejs.org/docs/latest/api/stream.html">documentation on streams</a>.</p>
<h1 id="install">install</h1>
<p>With <a href="https://npmjs.org">npm</a> do:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install stream-browserify
</pre></div>
</td></tr></table>

<p>but if you are using browserify you will get this module automatically when you
do <code>require('stream')</code>.</p>
