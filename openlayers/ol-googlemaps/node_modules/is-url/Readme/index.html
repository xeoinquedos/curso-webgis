...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>is-url - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#is-url" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#isurlstring" title="isUrl(string)" class="md-nav__link">
    isUrl(string)
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/is-url/Readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="is-url">is-url</h1>
<p>Check whether a string is a URL.</p>
<h2 id="installation">Installation</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install is-url
</pre></div>
</td></tr></table>

<h2 id="api">API</h2>
<h3 id="isurlstring"><code>isUrl(string)</code></h3>
<p>Returns a Boolean indicating whether <code>string</code> is a URL.</p>
