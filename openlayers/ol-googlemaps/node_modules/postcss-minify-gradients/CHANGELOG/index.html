...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-minify-gradients/CHANGELOG.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<li>Better handling of color stop positions in radial gradients, the module now
  correctly accounts for the first set of parameters potentially being
  directional and not stop values.</li>
</ul>
<h1 id="105">1.0.5</h1>
<ul>
