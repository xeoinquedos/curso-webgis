...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>minimist - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../../#minimist" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/quote-stream/node_modules/minimist/readme.markdown" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">argv</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minimist&#39;</span><span class="p">)(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">.</span><span class="nx">slice</span><span class="p">(</span><span class="mi">2</span><span class="p">));</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ node example/parse.js -a beep -b boop
<span class="o">{</span> _: <span class="o">[]</span>, a: <span class="s1">&#39;beep&#39;</span>, b: <span class="s1">&#39;boop&#39;</span> <span class="o">}</span>
</pre></div>
</td></tr></table>
...
7
8
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ node example/parse.js -x <span class="m">3</span> -y <span class="m">4</span> -n5 -abc --beep<span class="o">=</span>boop foo bar baz
<span class="o">{</span> _: <span class="o">[</span> <span class="s1">&#39;foo&#39;</span>, <span class="s1">&#39;bar&#39;</span>, <span class="s1">&#39;baz&#39;</span> <span class="o">]</span>,
  x: <span class="m">3</span>,
  y: <span class="m">4</span>,
  n: <span class="m">5</span>,
  a: true,
  b: true,
  c: true,
  beep: <span class="s1">&#39;boop&#39;</span> <span class="o">}</span>
</pre></div>
</td></tr></table>

<h1 id="methods">methods</h1>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">parseArgs</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minimist&#39;</span><span class="p">)</span>
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>&gt; require(&#39;./&#39;)(&#39;one two three -- four five --six&#39;.split(&#39; &#39;), { &#39;--&#39;: true })
{ _: [ &#39;one&#39;, &#39;two&#39;, &#39;three&#39; ],
  &#39;--&#39;: [ &#39;four&#39;, &#39;five&#39;, &#39;--six&#39; ] }
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install minimist
</pre></div>
</td></tr></table>
