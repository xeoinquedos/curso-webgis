...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-colormin/CHANGELOG.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="400-rc0">4.0.0-rc.0</h1>
<ul>
<li>Breaking: Drops support for Node 0.12, we now require at least Node 4.</li>
<li>Breaking: Drops the <code>legacy</code> option which was used to provide support for
  ...
  See https://github.com/ai/browserslist#config-file for more details.</li>
<li>Breaking: Update PostCSS to 6.0.0.</li>
<li>postcss-colormin will now no longer handle integer or whitespace compression;
  ...
  conversion between identical colors.</li>
</ul>
<h1 id="222">2.2.2</h1>
<ul>
