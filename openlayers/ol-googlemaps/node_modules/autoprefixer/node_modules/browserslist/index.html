...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#browsers" title="Browsers" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#major-browsers" title="Major Browsers" class="md-nav__link">
    Major Browsers
  </a>
  ...
  <a href="#others" title="Others" class="md-nav__link">
    Others
          ...
          <li class="md-nav__item">
  <a href="#electron" title="Electron" class="md-nav__link">
    Electron
  </a>
    ...
    Coverage
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/autoprefixer/node_modules/browserslist/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;browserslist&quot;</span><span class="p">:</span> <span class="p">[</span>
    ...
    <span class="s2">&quot;last 2 versions&quot;</span>
  <span class="p">]</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
<span class="l l-Scalar l-Scalar-Plain">Last 2 versions</span>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">const</span> <span class="nx">e2c</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;electron-to-chromium&#39;</span><span class="p">)</span>
<span class="nx">autoprefixer</span><span class="p">({</span>
    <span class="nx">browsers</span><span class="o">:</span> <span class="nx">e2c</span><span class="p">.</span><span class="nx">electronToBrowserList</span><span class="p">(</span><span class="s1">&#39;1.4&#39;</span><span class="p">)</span> <span class="c1">//=&gt; &quot;Chrome &gt;= 53&quot;</span>
<span class="p">})</span>
</pre></div>
</td></tr></table>
...
<span class="p p-Indicator">&gt;</span><span class="err"> 1%</span>
<span class="l l-Scalar l-Scalar-Plain">Last 2 versions</span>
<span class="l l-Scalar l-Scalar-Plain">IE 8</span> <span class="c1"># sorry</span>
</pre></div>
</td></tr></table>
...
10</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  ...
  <span class="s2">&quot;dependencies&quot;</span><span class="o">:</span> <span class="p">{</span>
    <span class="s2">&quot;autoprefixer&quot;</span><span class="o">:</span> <span class="s2">&quot;^6.5.4&quot;</span>
  <span class="p">},</span>
  <span class="s2">&quot;browserslist&quot;</span><span class="o">:</span> <span class="p">[</span>
    <span class="s2">&quot;&gt; 1%&quot;</span><span class="p">,</span>
    <span class="s2">&quot;last 2 versions&quot;</span>
  <span class="p">]</span>
<span class="p">}</span>
...
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  ...
  <span class="s2">&quot;browserslist&quot;</span><span class="o">:</span> <span class="p">{</span>
    <span class="s2">&quot;production&quot;</span><span class="o">:</span> <span class="p">[</span>
      <span class="s2">&quot;last 2 version&quot;</span><span class="p">,</span>
      <span class="s2">&quot;ie 9&quot;</span>
    <span class="p">],</span>
    <span class="s2">&quot;development&quot;</span><span class="o">:</span> <span class="p">[</span>
      <span class="s2">&quot;last 1 version&quot;</span>
    <span class="p">]</span>
  <span class="p">}</span>
<span class="p">}</span>
</pre></div>
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">[production]</span>
<span class="na">last 2 version</span>
<span class="na">ie 9</span>

<span class="k">[development]</span>
<span class="na">last 1 version</span>
</pre></div>
</td></tr></table>
...
<p><code>js
   var e=document.createElement('a');e.setAttribute('href', 'data:text/plain;charset=utf-8,'+encodeURIComponent(JSON.stringify(JSON.parse(localStorage['usage-data-by-id'])[localStorage['config-primary_usage']])));e.setAttribute('download','stats.json');document.body.appendChild(e);e.click();document.body.removeChild(e);</code>
3. Save the data to a <code>browserslist-stats.json</code> file in your project.</p>
</li>
</ol>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>browserslist <span class="s2">&quot;&gt; 1%, last 2 versions&quot;</span>
</pre></div>
</td></tr></table>

<h2 id="coverage">Coverage</h2>
<p>You can get total users coverage for selected browsers by JS API:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">browserslist</span><span class="p">.</span><span class="nx">coverage</span><span class="p">(</span><span class="nx">browserslist</span><span class="p">(</span><span class="s1">&#39;&gt; 1%&#39;</span><span class="p">))</span> <span class="c1">//=&gt; 81.4</span>
</pre></div>
</td></tr></table>

<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">browserslist</span><span class="p">.</span><span class="nx">coverage</span><span class="p">(</span><span class="nx">browserslist</span><span class="p">(</span><span class="s1">&#39;&gt; 1% in US&#39;</span><span class="p">),</span> <span class="s1">&#39;US&#39;</span><span class="p">)</span> <span class="c1">//=&gt; 83.1</span>
</pre></div>
</td></tr></table>
