...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#babel-plugin-transform-es2015-modules-umd" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#usage" title="Usage" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#via-babelrc-recommended" title="Via .babelrc (Recommended)" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#default-semantics" title="Default semantics" class="md-nav__link">
    Default semantics
  </a>
          ...
          <li class="md-nav__item">
  <a href="#more-flexible-semantics-with-exactglobals-true" title="More flexible semantics with exactGlobals: true" class="md-nav__link">
    More flexible semantics with exactGlobals: true
          ...
          <li class="md-nav__item">
  <a href="#via-cli" title="Via CLI" class="md-nav__link">
    Via CLI
  </a>
          ...
          <li class="md-nav__item">
  <a href="#via-node-api" title="Via Node API" class="md-nav__link">
    Via Node API
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/babel-plugin-transform-es2015-modules-umd/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">export</span> <span class="k">default</span> <span class="mi">42</span><span class="p">;</span>
</pre></div>
</td></tr></table>
...
19
20
21</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">global</span><span class="p">,</span> <span class="nx">factory</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
    ...
    <span class="nx">global</span><span class="p">.</span><span class="nx">actual</span> <span class="o">=</span> <span class="nx">mod</span><span class="p">.</span><span class="nx">exports</span><span class="p">;</span>
  <span class="p">}</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install --save-dev babel-plugin-transform-es2015-modules-umd
</pre></div>
</td></tr></table>
...
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;plugins&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-modules-umd&quot;</span><span class="p">]</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
9</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;plugins&quot;</span><span class="p">:</span> <span class="p">[</span>
    <span class="p">[</span><span class="s2">&quot;transform-es2015-modules-umd&quot;</span><span class="p">,</span> <span class="p">{</span>
      <span class="nt">&quot;globals&quot;</span><span class="p">:</span> <span class="p">{</span>
        <span class="nt">&quot;es6-promise&quot;</span><span class="p">:</span> <span class="s2">&quot;Promise&quot;</span>
      <span class="p">}</span>
    <span class="p">}]</span>
  <span class="p">]</span>
<span class="p">}</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">import</span> <span class="nx">fooBar1</span> <span class="nx">from</span> <span class="s2">&quot;foo-bar&quot;</span><span class="p">;</span>
<span class="kr">import</span> <span class="nx">fooBar2</span> <span class="nx">from</span> <span class="s2">&quot;./mylib/foo-bar&quot;</span><span class="p">;</span>
</pre></div>
</td></tr></table>

<p>it will transpile into two references to the same browser global:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">factory</span><span class="p">(</span><span class="nx">global</span><span class="p">.</span><span class="nx">fooBar</span><span class="p">,</span> <span class="nx">global</span><span class="p">.</span><span class="nx">fooBar</span><span class="p">);</span>
</pre></div>
</td></tr></table>
...
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;globals&quot;</span><span class="p">:</span> <span class="p">{</span>
    <span class="nt">&quot;foo-bar&quot;</span><span class="p">:</span> <span class="s2">&quot;fooBAR&quot;</span><span class="p">,</span>
    <span class="nt">&quot;./mylib/foo-bar&quot;</span><span class="p">:</span> <span class="s2">&quot;mylib.fooBar&quot;</span>
  <span class="p">}</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;globals&quot;</span><span class="p">:</span> <span class="p">{</span>
    <span class="nt">&quot;fizzbuzz&quot;</span><span class="p">:</span> <span class="s2">&quot;fizz.buzz&quot;</span>
  <span class="p">}</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
<h4 id="more-flexible-semantics-with-exactglobals-true">More flexible semantics with <code>exactGlobals: true</code></h4>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">factory</span><span class="p">(</span><span class="nx">global</span><span class="p">.</span><span class="nx">fooBar</span><span class="p">,</span> <span class="nx">global</span><span class="p">.</span><span class="nx">mylibFooBar</span><span class="p">);</span>
</pre></div>
</td></tr></table>
...
7</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;globals&quot;</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="nt">&quot;./mylib/foo-bar&quot;</span><span class="p">:</span> <span class="s2">&quot;mylib.fooBar&quot;</span>
  <span class="p">},</span>
  <span class="nt">&quot;exactGlobals&quot;</span><span class="p">:</span> <span class="kc">true</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>

<p>then it'll transpile to:</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">factory</span><span class="p">(</span><span class="nx">global</span><span class="p">.</span><span class="nx">fooBAR</span><span class="p">,</span> <span class="nx">global</span><span class="p">.</span><span class="nx">mylib</span><span class="p">.</span><span class="nx">fooBar</span><span class="p">)</span>
</pre></div>
</td></tr></table>
...
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">{</span>
  <span class="nt">&quot;plugins&quot;</span><span class="p">:</span> <span class="p">[</span>
    <span class="s2">&quot;external-helpers&quot;</span><span class="p">,</span>
    <span class="p">[</span><span class="s2">&quot;transform-es2015-modules-umd&quot;</span><span class="p">,</span> <span class="p">{</span>
      <span class="nt">&quot;globals&quot;</span><span class="p">:</span> <span class="p">{</span>
        <span class="nt">&quot;my/custom/module/name&quot;</span><span class="p">:</span> <span class="s2">&quot;My.Custom.Module.Name&quot;</span>
      <span class="p">},</span>
      <span class="nt">&quot;exactGlobals&quot;</span><span class="p">:</span> <span class="kc">true</span>
    <span class="p">}]</span>
  <span class="p">],</span>
  <span class="nt">&quot;moduleId&quot;</span><span class="p">:</span> <span class="s2">&quot;my/custom/module/name&quot;</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">factory</span><span class="p">(</span><span class="nx">mod</span><span class="p">.</span><span class="nx">exports</span><span class="p">);</span>
<span class="nx">global</span><span class="p">.</span><span class="nx">My</span> <span class="o">=</span> <span class="nx">global</span><span class="p">.</span><span class="nx">My</span> <span class="o">||</span> <span class="p">{};</span>
<span class="nx">global</span><span class="p">.</span><span class="nx">My</span><span class="p">.</span><span class="nx">Custom</span> <span class="o">=</span> <span class="nx">global</span><span class="p">.</span><span class="nx">My</span><span class="p">.</span><span class="nx">Custom</span> <span class="o">||</span> <span class="p">{};</span>
<span class="nx">global</span><span class="p">.</span><span class="nx">My</span><span class="p">.</span><span class="nx">Custom</span><span class="p">.</span><span class="nx">Module</span> <span class="o">=</span> <span class="nx">global</span><span class="p">.</span><span class="nx">My</span><span class="p">.</span><span class="nx">Custom</span><span class="p">.</span><span class="nx">Module</span> <span class="o">||</span> <span class="p">{};</span>
<span class="nx">global</span><span class="p">.</span><span class="nx">My</span><span class="p">.</span><span class="nx">Custom</span><span class="p">.</span><span class="nx">Module</span><span class="p">.</span><span class="nx">Name</span> <span class="o">=</span> <span class="nx">mod</span><span class="p">.</span><span class="nx">exports</span><span class="p">;</span>
</pre></div>
</td></tr></table>

<h3 id="via-cli">Via CLI</h3>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>babel --plugins transform-es2015-modules-umd script.js
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;babel-core&quot;</span><span class="p">).</span><span class="nx">transform</span><span class="p">(</span><span class="s2">&quot;code&quot;</span><span class="p">,</span> <span class="p">{</span>
  <span class="nx">plugins</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-modules-umd&quot;</span><span class="p">]</span>
<span class="p">});</span>
</pre></div>
</td></tr></table>
