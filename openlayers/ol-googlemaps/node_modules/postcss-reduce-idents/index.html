...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#postcss-reduce-idents" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#reduceidentsoptions" title="reduceIdents([options])" class="md-nav__link">
  ...
  <a href="#counter" title="counter" class="md-nav__link">
    counter
          ...
          <li class="md-nav__item">
  <a href="#keyframes" title="keyframes" class="md-nav__link">
    keyframes
  </a>
          ...
          <li class="md-nav__item">
  <a href="#counterstyle" title="counterStyle" class="md-nav__link">
    counterStyle
  </a>
          ...
          <li class="md-nav__item">
  <a href="#gridtemplate" title="gridTemplate" class="md-nav__link">
    gridTemplate
  </a>
          ...
          <li class="md-nav__item">
  <a href="#encoder" title="encoder" class="md-nav__link">
    encoder
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/postcss-reduce-idents/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="postcss-reduce-idents"><a href="https://github.com/postcss/postcss">postcss</a>-reduce-idents <a href="https://travis-ci.org/ben-eb/postcss-reduce-idents"><img alt="Build Status" src="https://travis-ci.org/ben-eb/postcss-reduce-idents.svg?branch=master" /></a> <a href="http://badge.fury.io/js/postcss-reduce-idents"><img alt="NPM version" src="https://badge.fury.io/js/postcss-reduce-idents.svg" /></a> <a href="https://gemnasium.com/ben-eb/postcss-reduce-idents"><img alt="Dependency Status" src="https://gemnasium.com/ben-eb/postcss-reduce-idents.svg" /></a></h1>
<blockquote>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install postcss-reduce-idents --save
</pre></div>
</td></tr></table>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">keyframes</span> <span class="nt">whiteToBlack</span> <span class="p">{</span>
    <span class="nt">0</span><span class="o">%</span> <span class="p">{</span>
        <span class="k">color</span><span class="p">:</span> <span class="mh">#fff</span>
    <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span>
        <span class="k">color</span><span class="p">:</span> <span class="mh">#000</span>
    <span class="p">}</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">one</span> <span class="p">{</span>
    <span class="k">animation-name</span><span class="p">:</span> <span class="n">whiteToBlack</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">keyframes</span> <span class="nt">a</span> <span class="p">{</span>
    <span class="nt">0</span><span class="o">%</span> <span class="p">{</span>
        <span class="k">color</span><span class="p">:</span> <span class="mh">#fff</span>
    <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span>
...
<span class="p">.</span><span class="nc">one</span> <span class="p">{</span>
    <span class="k">animation-name</span><span class="p">:</span> <span class="n">a</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="p">@</span><span class="k">keyframes</span> <span class="nt">fadeOut</span> <span class="p">{</span>
    <span class="nt">0</span><span class="o">%</span> <span class="p">{</span> <span class="k">opacity</span><span class="p">:</span> <span class="mi">1</span> <span class="p">}</span>
    <span class="nt">to</span> <span class="p">{</span> <span class="k">opacity</span><span class="p">:</span> <span class="mi">0</span> <span class="p">}</span>
<span class="p">}</span>

<span class="p">.</span><span class="nc">fadeIn</span> <span class="p">{</span>
    <span class="k">animation-name</span><span class="p">:</span> <span class="n">fadeIn</span><span class="p">;</span>
<span class="p">}</span>
</pre></div>
</td></tr></table>
