...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#fswatcher-child" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/fswatcher-child/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="fswatcher-child">FSWatcher child</h1>
<p><a href="https://travis-ci.org/DeMoorJasper/fswatcher-child"><img alt="Travis CI" src="https://travis-ci.org/DeMoorJasper/fswatcher-child.svg?branch=master" /></a>
<a href="https://ci.appveyor.com/project/DeMoorJasper/fswatcher-child/branch/master"><img alt="Build status" src="https://ci.appveyor.com/api/projects/status/bjuyeipiewvyqc11/branch/master?svg=true" /></a></p>
<p>FSWatcher child is a wrapper around chokidar's FSWatcher to provide an error prone layer between your code and chokidar using a child process.</p>
<p>To get a reliable result in testing listen for the <code>ready</code> event, as the watcher will not be able to look for file changes during startup times.</p>
