...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>safe-regex - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#safe-regex" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/safe-regex/readme.markdown" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<p><a href="https://ci.testling.com/substack/safe-regex"><img alt="browser support" src="https://ci.testling.com/substack/safe-regex.png" /></a></p>
<p><a href="http://travis-ci.org/substack/safe-regex"><img alt="build status" src="https://secure.travis-ci.org/substack/safe-regex.png" /></a></p>
<h1 id="example">example</h1>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">safe</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;safe-regex&#39;</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">regex</span> <span class="o">=</span> <span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">.</span><span class="nx">slice</span><span class="p">(</span><span class="mi">2</span><span class="p">).</span><span class="nx">join</span><span class="p">(</span><span class="s1">&#39; &#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">safe</span><span class="p">(</span><span class="nx">regex</span><span class="p">));</span>
</pre></div>
</td></tr></table>
...
6
7
8</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ node safe.js <span class="s1">&#39;(x+x+)+y&#39;</span>
<span class="nb">false</span>
$ node safe.js <span class="s1">&#39;(beep|boop)*&#39;</span>
<span class="nb">true</span>
$ node safe.js <span class="s1">&#39;(a+){10}&#39;</span>
<span class="nb">false</span>
$ node safe.js <span class="s1">&#39;\blocation\s*:[^:\n]+\b(Oakland|San Francisco)\b&#39;</span>
<span class="nb">true</span>
</pre></div>
</td></tr></table>

<h1 id="methods">methods</h1>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">safe</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;safe-regex&#39;</span><span class="p">)</span>
</pre></div>
</td></tr></table>

<h2 id="var-ok-safere-opts">var ok = safe(re, opts={})</h2>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install safe-regex
</pre></div>
</td></tr></table>
