...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#sprintfjs" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#javascript-vsprintf" title="JavaScript vsprintf" class="md-nav__link">
    JavaScript vsprintf
  </a>
        ...
        <li class="md-nav__item">
  <a href="#argument-swapping" title="Argument swapping" class="md-nav__link">
    Argument swapping
  </a>
        ...
        <li class="md-nav__item">
  <a href="#named-arguments" title="Named arguments" class="md-nav__link">
    Named arguments
  </a>
        ...
        <li class="md-nav__item">
  <a href="#computed-values" title="Computed values" class="md-nav__link">
    Computed values
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/sprintf-js/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>string sprintf(string format , [mixed arg1 [, mixed arg2 [ ,...]]])
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>vsprintf(&quot;The first 4 letters of the english alphabet are: %s, %s, %s and %s&quot;, [&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;])
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>sprintf(&quot;%2$s %3$s a %1$s&quot;, &quot;cracker&quot;, &quot;Polly&quot;, &quot;wants&quot;)
</pre></div>
</td></tr></table>
...
2
3
4</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>var user = {
    name: &quot;Dolly&quot;
}
...
4
5
6</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>var users = [
    {name: &quot;Dolly&quot;},
    {name: &quot;Molly&quot;},
    {name: &quot;Polly&quot;}
]
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1
2</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>sprintf(&quot;Current timestamp: %d&quot;, Date.now) // Current timestamp: 1398005382890
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>bower install sprintf
</pre></div>
</td></tr></table>

<h2 id="or-as-a-nodejs-module">Or as a node.js module</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install sprintf-js
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>var sprintf = require(&quot;sprintf-js&quot;).sprintf,
