...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#boolbase" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#wtf" title="WTF?" class="md-nav__link">
    WTF?
  </a>
        ...
        <li class="md-nav__item">
  <a href="#and-why-is-this-a-separate-module" title="And why is this a separate module?" class="md-nav__link">
    And why is this a separate module?
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/boolbase/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="boolbase">boolbase</h1>
<p>This very simple module provides two basic functions, one that always returns true (<code>trueFunc</code>) and one that always returns false (<code>falseFunc</code>).</p>
<h3 id="wtf">WTF?</h3>
...
<h3 id="and-why-is-this-a-separate-module">And why is this a separate module?</h3>
