...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../../#util" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#install-via-npm" title="install via npm" class="md-nav__link">
    install via npm
  </a>
    ...
    browser support
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/assert/node_modules/util/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="util">util</h1>
<p><a href="https://travis-ci.org/defunctzombie/node-util"><img alt="Build Status" src="https://travis-ci.org/defunctzombie/node-util.png?branch=master" /></a></p>
<p>node.js <a href="http://nodejs.org/api/util.html">util</a> module as a module</p>
<h2 id="install-via-npm">install via <a href="npmjs.org">npm</a></h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install util
</pre></div>
</td></tr></table>
