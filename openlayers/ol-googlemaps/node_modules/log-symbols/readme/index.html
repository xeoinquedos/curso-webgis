...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-3.0.4">
        ...
        <title>log-symbols [![Build Status](https://travis-ci.org/sindresorhus/log-symbols.svg?branch=master)](https://travis-ci.org/sindresorhus/log-symbols) - Curso WebGIS. Mapas libres con Leaflet y OpenLayers</title>
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../../#log-symbols" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#logsymbols" title="logSymbols" class="md-nav__link">
    logSymbols
  </a>
    ...
    License
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/log-symbols/readme.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="log-symbols">log-symbols <a href="https://travis-ci.org/sindresorhus/log-symbols"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/log-symbols.svg?branch=master" /></a></h1>
<p><img src="screenshot.png" width="226" align="right"></p>
<blockquote>
<p>Colored symbols for various log levels</p>
</blockquote>
<p>Includes fallbacks for Windows CMD which only supports a <a href="https://en.wikipedia.org/wiki/Code_page_437">limited character set</a>.</p>
<h2 id="install">Install</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>$ npm install log-symbols
</pre></div>
</td></tr></table>
...
3
4
5</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">const</span> <span class="nx">logSymbols</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;log-symbols&#39;</span><span class="p">);</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">logSymbols</span><span class="p">.</span><span class="nx">success</span><span class="p">,</span> <span class="s1">&#39;Finished successfully!&#39;</span><span class="p">);</span>
<span class="c1">// On good OSes:  ✔ Finished successfully!</span>
<span class="c1">// On Windows:    √ Finished successfully!</span>
</pre></div>
</td></tr></table>

<h2 id="api">API</h2>
<h3 id="logsymbols">logSymbols</h3>
<h4 id="info">info</h4>
...
<li><a href="https://github.com/ManrajGrover/py-log-symbols">py-log-symbols</a> - Python port</li>
</ul>
