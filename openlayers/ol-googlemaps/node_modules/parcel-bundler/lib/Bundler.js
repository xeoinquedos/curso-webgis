...
class Bundler extends EventEmitter {
  ...
  resolveAsset(name, parent) {
    ...
    return _asyncToGenerator(function* () {
      var _ref = yield _this6.resolver.resolve(name, parent);
      ...
      try {
        ...
        if (err.code === 'MODULE_NOT_FOUND') {
          ...
          if (!isLocalFile && !fromNodeModules && _this9.options.autoinstall && install) {
            return yield _this9.installDep(asset, dep);
          }
  ...
  installDep(asset, dep) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let resolved = yield _this10.resolver.resolveModule(dep.name, asset.name);
      ...
      return yield _this10.resolveDep(asset, dep, false);
    })();
  }
  ...
  *findOrphanAssets() {
  ...
  onChange(path) {
    ...
    return _asyncToGenerator(function* () {
      let assets = _this13.watchedAssets.get(path);
      ...
      try {
        for (var _iterator11 = assets[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
          ...
          _this13.buildQueue.add(asset, true);
        }
      } catch (err) {
      ...
      clearTimeout(_this13.rebuildTimeout);

      _this13.rebuildTimeout = setTimeout(_asyncToGenerator(function* () {
  ...
  serve(port = 1234, https = false) {
    ...
    return _asyncToGenerator(function* () {
      _this14.server = yield Server.serve(_this14, port, https);
      try {
        yield _this14.bundle();
      } catch (e) {
        // ignore: server can still work with errored bundler
      }
      return _this14.server;
    })();
  }
}
