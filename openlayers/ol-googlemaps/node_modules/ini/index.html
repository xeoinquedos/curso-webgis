  ...
  <a href="#api" title="API" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#decodeinistring" title="decode(inistring)" class="md-nav__link">
    decode(inistring)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parseinistring" title="parse(inistring)" class="md-nav__link">
    parse(inistring)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#encodeobject-options" title="encode(object, [options])" class="md-nav__link">
    encode(object, [options])
          ...
          <li class="md-nav__item">
  <a href="#stringifyobject-options" title="stringify(object, [options])" class="md-nav__link">
    stringify(object, [options])
          ...
          <li class="md-nav__item">
  <a href="#safeval" title="safe(val)" class="md-nav__link">
    safe(val)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#unsafeval" title="unsafe(val)" class="md-nav__link">
    unsafe(val)
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/ini/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
...
11
12
13</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>; this comment is being ignored
scope = global
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>var fs = require(&#39;fs&#39;)
  , ini = require(&#39;ini&#39;)
...
10
11
12</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="k">[section]</span>
...
<h3 id="encodeobject-options">encode(object, [options])</h3>
...
<h3 id="stringifyobject-options">stringify(object, [options])</h3>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>ini.safe(&#39;&quot;unsafe string&quot;&#39;)
</pre></div>
</td></tr></table>

<p>would result in</p>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>&quot;\&quot;unsafe string\&quot;&quot;
</pre></div>
</td></tr></table>
