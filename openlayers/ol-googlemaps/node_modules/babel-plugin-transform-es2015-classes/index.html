...
<html lang="es" class="no-js">
  ...
  <path fill="currentColor" d="M160 304q0 10-3.125 20.5t-10.75 19-18.125
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="../../../../#babel-plugin-transform-es2015-classes" tabindex="1" class="md-skip">
        Saltar a contenido
      </a>
  ...
  <a href="#loose" title="loose" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#method-enumerability" title="Method enumerability" class="md-nav__link">
    Method enumerability
          ...
          <li class="md-nav__item">
  <a href="#method-assignment" title="Method assignment" class="md-nav__link">
    Method assignment
  </a>
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/xeoinquedos/curso-webgis/edit/master/docs/openlayers/ol-googlemaps/node_modules/babel-plugin-transform-es2015-classes/README.md" title="Editar esta página" class="md-icon md-content__icon">&#xE3C9;</a>
                
                
                <h1 id="babel-plugin-transform-es2015-classes">babel-plugin-transform-es2015-classes</h1>
<blockquote>
<p>Compile ES2015 classes to ES5</p>
</blockquote>
<h2 id="caveats">Caveats</h2>
<p>Built-in classes such as <code>Date</code>, <code>Array</code>, <code>DOM</code> etc cannot be properly subclassed
due to limitations in ES5 (for the <a href="http://babeljs.io/docs/plugins/transform-es2015-classes">es2015-classes</a> plugin).
You can try to use <a href="https://github.com/loganfsmyth/babel-plugin-transform-builtin-extend">babel-plugin-transform-builtin-extend</a> based on <code>Object.setPrototypeOf</code> and <code>Reflect.construct</code>, but it also has some limitations.</p>
<h2 id="installation">Installation</h2>
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>npm install --save-dev babel-plugin-transform-es2015-classes
</pre></div>
</td></tr></table>
...
<span class="p">{</span>
  <span class="s2">&quot;plugins&quot;</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-classes&quot;</span><span class="p">]</span>
<span class="p">}</span>

<span class="c1">// with options</span>
<span class="p">{</span>
  <span class="s2">&quot;plugins&quot;</span><span class="o">:</span> <span class="p">[</span>
    <span class="p">[</span><span class="s2">&quot;transform-es2015-classes&quot;</span><span class="p">,</span> <span class="p">{</span>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1</pre></div></td><td class="code"><div class="codehilite"><pre><span></span>babel --plugins transform-es2015-classes script.js
</pre></div>
</td></tr></table>
...
3</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;babel-core&quot;</span><span class="p">).</span><span class="nx">transform</span><span class="p">(</span><span class="s2">&quot;code&quot;</span><span class="p">,</span> <span class="p">{</span>
  <span class="nx">plugins</span><span class="o">:</span> <span class="p">[</span><span class="s2">&quot;transform-es2015-classes&quot;</span><span class="p">]</span>
<span class="p">});</span>
</pre></div>
</td></tr></table>
...
<table class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre> 1
 ...
 9
10
11</pre></div></td><td class="code"><div class="codehilite"><pre><span></span><span class="kr">class</span> <span class="nx">Foo</span> <span class="p">{</span>
